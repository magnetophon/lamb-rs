...
struct GainReductionMeterBar<L, P>
where
    L: Lens<Target = f32>,
    P: Lens<Target = f32>,
{
...
impl GainReductionMeter {
    /// Creates a new [`GainReductionMeter`] for the given value in decibel, optionally holding the peak
...
impl View for GainReductionMeter {
    fn element(&self) -> Option<&'static str> {
        Some("peak-meter")
    }
}

impl<L, P> View for GainReductionMeterBar<L, P>
where
    L: Lens<Target = f32>,
    P: Lens<Target = f32>,
{
