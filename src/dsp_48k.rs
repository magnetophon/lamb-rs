...
Compilation options: -a /tmp/.tmpovMpki -lang rust -ct 1 -cn LambRs48k -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */
mod dsp_48k {
    #![allow(clippy::all)]
    #![allow(unused_parens)]
    ...
    impl LambRs48k {
        ...
        pub fn metadata(&self, m: &mut dyn Meta) {
            ...
            m.declare("compile_options", r"-a /tmp/.tmpovMpki -lang rust -ct 1 -cn LambRs48k -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
