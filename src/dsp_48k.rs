...
Compilation options: -a /run/user/1001/.tmpIbzq1R -lang rust -ct 1 -cn LambRs48k -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */
mod dsp_48k {
    #![allow(clippy::all)]
    #![allow(unused_parens)]
...
impl FaustDsp for LambRs48k {
	...
	fn metadata(&self, m: &mut dyn Meta) { 
		...
		m.declare("compile_options", r"-a /run/user/1001/.tmpIbzq1R -lang rust -ct 1 -cn LambRs48k -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
	...
	fn compute(&mut self, count: i32, inputs: &[&[Self::T]], outputs: &mut[&mut[Self::T]]) {
		...
		self.fHbargraph0 = if (fSlow15) as i32 != 0 {4.8e+03} else {fSlow17};
		...
		let mut iSlow48: i32 = (F64::floor(0.5 * fSlow3)) as i32 % 2;
		let mut iSlow49: i32 = (F64::floor(0.25 * fSlow3)) as i32 % 2;
		let mut iSlow50: i32 = i32::wrapping_add(iSlow4, i32::wrapping_mul(2, iSlow48));
		let mut iSlow51: i32 = (F64::floor(0.125 * fSlow3)) as i32 % 2;
		let mut iSlow52: i32 = i32::wrapping_add(iSlow50, i32::wrapping_mul(4, iSlow49));
		let mut iSlow53: i32 = (F64::floor(0.0625 * fSlow3)) as i32 % 2;
		let mut iSlow54: i32 = i32::wrapping_add(iSlow52, i32::wrapping_mul(8, iSlow51));
		let mut iSlow55: i32 = (F64::floor(0.03125 * fSlow3)) as i32 % 2;
		let mut iSlow56: i32 = i32::wrapping_add(iSlow54, i32::wrapping_mul(16, iSlow53));
		let mut iSlow57: i32 = (F64::floor(0.015625 * fSlow3)) as i32 % 2;
		let mut iSlow58: i32 = i32::wrapping_add(iSlow56, i32::wrapping_mul(32, iSlow55));
		let mut iSlow59: i32 = (F64::floor(0.0078125 * fSlow3)) as i32 % 2;
		let mut iSlow60: i32 = i32::wrapping_add(iSlow58, i32::wrapping_mul(64, iSlow57));
		let mut iSlow61: i32 = (F64::floor(0.00390625 * fSlow3)) as i32 % 2;
		let mut iSlow62: i32 = i32::wrapping_add(iSlow60, i32::wrapping_mul(128, iSlow59));
		let mut iSlow63: i32 = (F64::floor(0.001953125 * fSlow3)) as i32 % 2;
		let mut iSlow64: i32 = i32::wrapping_add(iSlow62, i32::wrapping_mul(256, iSlow61));
		let mut iSlow65: i32 = (F64::floor(0.0009765625 * fSlow3)) as i32 % 2;
		let mut iSlow66: i32 = i32::wrapping_add(iSlow64, i32::wrapping_mul(512, iSlow63));
		let mut iSlow67: i32 = (F64::floor(0.00048828125 * fSlow3)) as i32 % 2;
		let mut iSlow68: i32 = i32::wrapping_add(iSlow66, i32::wrapping_mul(1024, iSlow65));
		let mut fSlow69: F64 = self.fHslider10;
		let mut fSlow70: F64 = self.fHslider11;
		let mut iSlow71: i32 = (F64::max(0.0, fSlow15 * (4.8e+03 - fSlow17))) as i32;
		...
		for (((((input0, input1), output0), output1), output2), output3) in zipped_iterators {
			...
			let mut fTemp41: F64 = F64::min(fTemp34, F64::powf(1e+01, -(fSlow22 * F64::max(0.0, if (iTemp39 == 0) as i32 != 0 {0.0} else {if (iTemp39 == 1) as i32 != 0 {fSlow12 * LambRs48k_faustpower2_f(fSlow7 + fTemp40)} else {fTemp40}}))));
			...
			self.fRec3[0] = F64::max(F64::min(self.fRec3[1], self.fVec5[((i32::wrapping_sub(self.IOTA0, iSlow24)) & 16383) as usize]), F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(if iSlow26 != 0 {fTemp41} else {1.7976931348623157e+308}, if iSlow27 != 0 {self.fVec6[iSlow26 as usize]} else {1.7976931348623157e+308}), if iSlow28 != 0 {self.fVec7[iSlow29 as usize]} else {1.7976931348623157e+308}), if iSlow30 != 0 {self.fVec8[iSlow31 as usize]} else {1.7976931348623157e+308}), if iSlow32 != 0 {self.fVec9[((i32::wrapping_sub(self.IOTA0, iSlow33)) & 31) as usize]} else {1.7976931348623157e+308}), if iSlow34 != 0 {self.fVec10[((i32::wrapping_sub(self.IOTA0, iSlow35)) & 63) as usize]} else {1.7976931348623157e+308}), if iSlow36 != 0 {self.fVec11[((i32::wrapping_sub(self.IOTA0, iSlow37)) & 127) as usize]} else {1.7976931348623157e+308}), if iSlow38 != 0 {self.fVec12[((i32::wrapping_sub(self.IOTA0, iSlow39)) & 255) as usize]} else {1.7976931348623157e+308}), if iSlow40 != 0 {self.fVec13[((i32::wrapping_sub(self.IOTA0, iSlow41)) & 511) as usize]} else {1.7976931348623157e+308}), if iSlow42 != 0 {self.fVec14[((i32::wrapping_sub(self.IOTA0, iSlow43)) & 1023) as usize]} else {1.7976931348623157e+308}), if iSlow44 != 0 {self.fVec15[((i32::wrapping_sub(self.IOTA0, iSlow45)) & 2047) as usize]} else {1.7976931348623157e+308}), if iSlow46 != 0 {self.fVec16[((i32::wrapping_sub(self.IOTA0, iSlow47)) & 4095) as usize]} else {1.7976931348623157e+308}));
			...
			let mut fTemp62: F64 = F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(if iSlow4 != 0 {self.fRec3[0]} else {1.7976931348623157e+308}, if iSlow48 != 0 {self.fVec17[iSlow4 as usize]} else {1.7976931348623157e+308}), if iSlow49 != 0 {self.fVec18[iSlow50 as usize]} else {1.7976931348623157e+308}), if iSlow51 != 0 {self.fVec19[iSlow52 as usize]} else {1.7976931348623157e+308}), if iSlow53 != 0 {self.fVec20[((i32::wrapping_sub(self.IOTA0, iSlow54)) & 31) as usize]} else {1.7976931348623157e+308}), if iSlow55 != 0 {self.fVec21[((i32::wrapping_sub(self.IOTA0, iSlow56)) & 63) as usize]} else {1.7976931348623157e+308}), if iSlow57 != 0 {self.fVec22[((i32::wrapping_sub(self.IOTA0, iSlow58)) & 127) as usize]} else {1.7976931348623157e+308}), if iSlow59 != 0 {self.fVec23[((i32::wrapping_sub(self.IOTA0, iSlow60)) & 255) as usize]} else {1.7976931348623157e+308}), if iSlow61 != 0 {self.fVec24[((i32::wrapping_sub(self.IOTA0, iSlow62)) & 511) as usize]} else {1.7976931348623157e+308}), if iSlow63 != 0 {self.fVec25[((i32::wrapping_sub(self.IOTA0, iSlow64)) & 1023) as usize]} else {1.7976931348623157e+308}), if iSlow65 != 0 {self.fVec26[((i32::wrapping_sub(self.IOTA0, iSlow66)) & 2047) as usize]} else {1.7976931348623157e+308}), if iSlow67 != 0 {self.fVec27[((i32::wrapping_sub(self.IOTA0, iSlow68)) & 4095) as usize]} else {1.7976931348623157e+308}) - fTemp5;
			self.fVec28[0] = fTemp62;
			let mut iTemp63: i32 = (fTemp62 > 0.0) as i32;
			let mut fTemp69: F64 = if iTemp63 != 0 {fSlow70} else {fSlow69};
			...
			let mut fTemp74: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp73, 3)) as usize] };
			...
			let mut fTemp78: F64 = fTemp75 + fTemp77 * fTemp76 + 0.5 * (fTemp74 - (fTemp75 + fTemp77 * (fTemp76 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp73, 4)) as usize] } - fTemp74))));
			...
			let mut fTemp87: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp86, 3)) as usize] };
			...
			let mut fTemp93: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp92, 3), 196607))) as usize] };
			let mut fTemp94: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp92 as usize] };
			let mut fTemp95: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp92, 1), 196607))) as usize] } - fTemp94;
			let mut fTemp96: F64 = 2.0 * self.fVec29[1];
			...
			let mut fTemp102: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp101, 3), 196607))) as usize] };
			let mut fTemp103: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp101 as usize] };
			let mut fTemp104: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp101, 1), 196607))) as usize] } - fTemp103;
			...
			let mut fTemp109: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp108, 3), 196607))) as usize] };
			let mut fTemp110: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp108 as usize] };
			let mut fTemp111: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp108, 1), 196607))) as usize] } - fTemp110;
			...
			let mut fTemp116: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp115, 3)) as usize] };
			...
			let mut fTemp122: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp121, 3), 196607))) as usize] };
			let mut fTemp123: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp121 as usize] };
			let mut fTemp124: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp121, 1), 196607))) as usize] } - fTemp123;
			...
			let mut fTemp129: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp128, 3)) as usize] };
			...
			let mut fTemp135: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp134, 3), 196607))) as usize] };
			let mut fTemp136: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp134 as usize] };
			let mut fTemp137: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp134, 1), 196607))) as usize] } - fTemp136;
			let mut fTemp138: F64 = (if iTemp63 != 0 {fTemp136 + fTemp77 * fTemp137 + (fTemp132 - (iTemp133) as F64) * (fTemp135 - (fTemp136 + fTemp77 * (fTemp137 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp134, 4), 196607))) as usize] } - fTemp135))))} else {1.0 - (fTemp130 + fTemp77 * fTemp131 + (fTemp126 - (iTemp127) as F64) * (fTemp129 - (fTemp130 + fTemp77 * (fTemp131 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp128, 4)) as usize] } - fTemp129)))))} - if iTemp63 != 0 {fTemp123 + fTemp77 * fTemp124 + (fTemp119 - (iTemp120) as F64) * (fTemp122 - (fTemp123 + fTemp77 * (fTemp124 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp121, 4), 196607))) as usize] } - fTemp122))))} else {1.0 - (fTemp117 + fTemp77 * fTemp118 + (fTemp113 - (iTemp114) as F64) * (fTemp116 - (fTemp117 + fTemp77 * (fTemp118 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp115, 4), 196607))) as usize] } - fTemp116)))))}) * self.fVec28[1] / (fTemp62 * (1.0 - if iTemp63 != 0 {fTemp110 + fTemp105 * fTemp111 + (fTemp106 - (iTemp107) as F64) * (fTemp109 - (fTemp110 + fTemp105 * (fTemp111 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp108, 4), 196607))) as usize] } - fTemp109))))} else {1.0 - (fTemp103 + fTemp105 * fTemp104 + (fTemp99 - (iTemp100) as F64) * (fTemp102 - (fTemp103 + fTemp105 * (fTemp104 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp101, 4), 196607))) as usize] } - fTemp102)))))}));
			let mut iTemp139: i32 = (fTemp138 > ((if iTemp63 != 0 {fTemp94 + fTemp77 * fTemp95 + (fTemp90 - (iTemp91) as F64) * (fTemp93 - (fTemp94 + fTemp77 * (fTemp95 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp92, 4), 196607))) as usize] } - fTemp93))))} else {1.0 - (fTemp88 + fTemp77 * fTemp89 + (fTemp84 - (iTemp85) as F64) * (fTemp87 - (fTemp88 + fTemp77 * (fTemp89 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp86, 4)) as usize] } - fTemp87)))))} - fTemp79) / (1.0 - fTemp79))) as i32;
			...
			let mut fTemp147: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp146, 3)) as usize] };
			...
			let mut fTemp153: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp152, 3)) as usize] };
			...
			let mut fTemp156: F64 = if iTemp63 != 0 {fTemp154 + fTemp77 * fTemp155 + (fTemp150 - (iTemp151) as F64) * (fTemp153 - (fTemp154 + fTemp77 * (fTemp155 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp152, 4)) as usize] } - fTemp153))))} else {1.0 - (fTemp148 + fTemp77 * fTemp149 + (fTemp144 - (iTemp145) as F64) * (fTemp147 - (fTemp148 + fTemp77 * (fTemp149 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp146, 4)) as usize] } - fTemp147)))))};
			...
			let mut fTemp161: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp160, 3)) as usize] };
			...
			let mut fTemp167: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp166, 3), 196607))) as usize] };
			let mut fTemp168: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp166 as usize] };
			let mut fTemp169: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp166, 1), 196607))) as usize] } - fTemp168;
			let mut iTemp170: i32 = (fTemp138 > ((if iTemp63 != 0 {fTemp168 + fTemp77 * fTemp169 + (fTemp164 - (iTemp165) as F64) * (fTemp167 - (fTemp168 + fTemp77 * (fTemp169 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp166, 4), 196607))) as usize] } - fTemp167))))} else {1.0 - (fTemp162 + fTemp77 * fTemp163 + (fTemp158 - (iTemp159) as F64) * (fTemp161 - (fTemp162 + fTemp77 * (fTemp163 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp160, 4)) as usize] } - fTemp161)))))} - fTemp156) / (1.0 - fTemp156))) as i32;
			...
			let mut fTemp178: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp177, 3)) as usize] };
			...
			let mut fTemp184: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp183, 3)) as usize] };
			...
			let mut fTemp187: F64 = if iTemp63 != 0 {fTemp185 + fTemp77 * fTemp186 + (fTemp181 - (iTemp182) as F64) * (fTemp184 - (fTemp185 + fTemp77 * (fTemp186 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp183, 4)) as usize] } - fTemp184))))} else {1.0 - (fTemp179 + fTemp77 * fTemp180 + (fTemp175 - (iTemp176) as F64) * (fTemp178 - (fTemp179 + fTemp77 * (fTemp180 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp177, 4)) as usize] } - fTemp178)))))};
			...
			let mut fTemp192: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp191, 3)) as usize] };
			...
			let mut fTemp198: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp197, 3), 196607))) as usize] };
			let mut fTemp199: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp197 as usize] };
			let mut fTemp200: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp197, 1), 196607))) as usize] } - fTemp199;
			let mut iTemp201: i32 = (fTemp138 > ((if iTemp63 != 0 {fTemp199 + fTemp77 * fTemp200 + (fTemp195 - (iTemp196) as F64) * (fTemp198 - (fTemp199 + fTemp77 * (fTemp200 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp197, 4), 196607))) as usize] } - fTemp198))))} else {1.0 - (fTemp193 + fTemp77 * fTemp194 + (fTemp189 - (iTemp190) as F64) * (fTemp192 - (fTemp193 + fTemp77 * (fTemp194 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp191, 4)) as usize] } - fTemp192)))))} - fTemp187) / (1.0 - fTemp187))) as i32;
			...
			let mut fTemp209: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp208, 3)) as usize] };
			...
			let mut fTemp215: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp214, 3)) as usize] };
			...
			let mut fTemp218: F64 = if iTemp63 != 0 {fTemp216 + fTemp77 * fTemp217 + (fTemp212 - (iTemp213) as F64) * (fTemp215 - (fTemp216 + fTemp77 * (fTemp217 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp214, 4)) as usize] } - fTemp215))))} else {1.0 - (fTemp210 + fTemp77 * fTemp211 + (fTemp206 - (iTemp207) as F64) * (fTemp209 - (fTemp210 + fTemp77 * (fTemp211 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp208, 4)) as usize] } - fTemp209)))))};
			...
			let mut fTemp223: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp222, 3)) as usize] };
			...
			let mut fTemp229: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp228, 3), 196607))) as usize] };
			let mut fTemp230: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp228 as usize] };
			let mut fTemp231: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp228, 1), 196607))) as usize] } - fTemp230;
			let mut iTemp232: i32 = (fTemp138 > ((if iTemp63 != 0 {fTemp230 + fTemp77 * fTemp231 + (fTemp226 - (iTemp227) as F64) * (fTemp229 - (fTemp230 + fTemp77 * (fTemp231 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp228, 4), 196607))) as usize] } - fTemp229))))} else {1.0 - (fTemp224 + fTemp77 * fTemp225 + (fTemp220 - (iTemp221) as F64) * (fTemp223 - (fTemp224 + fTemp77 * (fTemp225 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp222, 4)) as usize] } - fTemp223)))))} - fTemp218) / (1.0 - fTemp218))) as i32;
			...
			let mut fTemp240: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp239, 3)) as usize] };
			...
			let mut fTemp246: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp245, 3)) as usize] };
			...
			let mut fTemp249: F64 = if iTemp63 != 0 {fTemp247 + fTemp77 * fTemp248 + (fTemp243 - (iTemp244) as F64) * (fTemp246 - (fTemp247 + fTemp77 * (fTemp248 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp245, 4)) as usize] } - fTemp246))))} else {1.0 - (fTemp241 + fTemp77 * fTemp242 + (fTemp237 - (iTemp238) as F64) * (fTemp240 - (fTemp241 + fTemp77 * (fTemp242 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp239, 4)) as usize] } - fTemp240)))))};
			...
			let mut fTemp254: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp253, 3)) as usize] };
			...
			let mut fTemp260: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp259, 3), 196607))) as usize] };
			let mut fTemp261: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp259 as usize] };
			let mut fTemp262: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp259, 1), 196607))) as usize] } - fTemp261;
			let mut iTemp263: i32 = (fTemp138 > ((if iTemp63 != 0 {fTemp261 + fTemp77 * fTemp262 + (fTemp257 - (iTemp258) as F64) * (fTemp260 - (fTemp261 + fTemp77 * (fTemp262 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp259, 4), 196607))) as usize] } - fTemp260))))} else {1.0 - (fTemp255 + fTemp77 * fTemp256 + (fTemp251 - (iTemp252) as F64) * (fTemp254 - (fTemp255 + fTemp77 * (fTemp256 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp253, 4)) as usize] } - fTemp254)))))} - fTemp249) / (1.0 - fTemp249))) as i32;
			...
			let mut fTemp271: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp270, 3)) as usize] };
			...
			let mut fTemp277: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp276, 3)) as usize] };
			...
			let mut fTemp280: F64 = if iTemp63 != 0 {fTemp278 + fTemp77 * fTemp279 + (fTemp274 - (iTemp275) as F64) * (fTemp277 - (fTemp278 + fTemp77 * (fTemp279 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp276, 4)) as usize] } - fTemp277))))} else {1.0 - (fTemp272 + fTemp77 * fTemp273 + (fTemp268 - (iTemp269) as F64) * (fTemp271 - (fTemp272 + fTemp77 * (fTemp273 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp270, 4)) as usize] } - fTemp271)))))};
			...
			let mut fTemp285: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp284, 3)) as usize] };
			...
			let mut fTemp291: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp290, 3), 196607))) as usize] };
			let mut fTemp292: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp290 as usize] };
			let mut fTemp293: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp290, 1), 196607))) as usize] } - fTemp292;
			let mut iTemp294: i32 = (fTemp138 > ((if iTemp63 != 0 {fTemp292 + fTemp77 * fTemp293 + (fTemp288 - (iTemp289) as F64) * (fTemp291 - (fTemp292 + fTemp77 * (fTemp293 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp290, 4), 196607))) as usize] } - fTemp291))))} else {1.0 - (fTemp286 + fTemp77 * fTemp287 + (fTemp282 - (iTemp283) as F64) * (fTemp285 - (fTemp286 + fTemp77 * (fTemp287 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp284, 4)) as usize] } - fTemp285)))))} - fTemp280) / (1.0 - fTemp280))) as i32;
			...
			let mut fTemp302: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp301, 3)) as usize] };
			...
			let mut fTemp308: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp307, 3)) as usize] };
			...
			let mut fTemp311: F64 = if iTemp63 != 0 {fTemp309 + fTemp77 * fTemp310 + (fTemp305 - (iTemp306) as F64) * (fTemp308 - (fTemp309 + fTemp77 * (fTemp310 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp307, 4)) as usize] } - fTemp308))))} else {1.0 - (fTemp303 + fTemp77 * fTemp304 + (fTemp299 - (iTemp300) as F64) * (fTemp302 - (fTemp303 + fTemp77 * (fTemp304 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp301, 4)) as usize] } - fTemp302)))))};
			...
			let mut fTemp316: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp315, 3)) as usize] };
			...
			let mut fTemp322: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp321, 3), 196607))) as usize] };
			let mut fTemp323: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp321 as usize] };
			let mut fTemp324: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp321, 1), 196607))) as usize] } - fTemp323;
			let mut iTemp325: i32 = (fTemp138 > ((if iTemp63 != 0 {fTemp323 + fTemp77 * fTemp324 + (fTemp319 - (iTemp320) as F64) * (fTemp322 - (fTemp323 + fTemp77 * (fTemp324 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp321, 4), 196607))) as usize] } - fTemp322))))} else {1.0 - (fTemp317 + fTemp77 * fTemp318 + (fTemp313 - (iTemp314) as F64) * (fTemp316 - (fTemp317 + fTemp77 * (fTemp318 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp315, 4)) as usize] } - fTemp316)))))} - fTemp311) / (1.0 - fTemp311))) as i32;
			...
			let mut fTemp333: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp332, 3)) as usize] };
			...
			let mut fTemp339: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp338, 3)) as usize] };
			...
			let mut fTemp342: F64 = if iTemp63 != 0 {fTemp340 + fTemp77 * fTemp341 + (fTemp336 - (iTemp337) as F64) * (fTemp339 - (fTemp340 + fTemp77 * (fTemp341 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp338, 4)) as usize] } - fTemp339))))} else {1.0 - (fTemp334 + fTemp77 * fTemp335 + (fTemp330 - (iTemp331) as F64) * (fTemp333 - (fTemp334 + fTemp77 * (fTemp335 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp332, 4)) as usize] } - fTemp333)))))};
			...
			let mut fTemp347: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp346, 3)) as usize] };
			...
			let mut fTemp353: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp352, 3), 196607))) as usize] };
			let mut fTemp354: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp352 as usize] };
			let mut fTemp355: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp352, 1), 196607))) as usize] } - fTemp354;
			let mut iTemp356: i32 = (fTemp138 > ((if iTemp63 != 0 {fTemp354 + fTemp77 * fTemp355 + (fTemp350 - (iTemp351) as F64) * (fTemp353 - (fTemp354 + fTemp77 * (fTemp355 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp352, 4), 196607))) as usize] } - fTemp353))))} else {1.0 - (fTemp348 + fTemp77 * fTemp349 + (fTemp344 - (iTemp345) as F64) * (fTemp347 - (fTemp348 + fTemp77 * (fTemp349 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp346, 4)) as usize] } - fTemp347)))))} - fTemp342) / (1.0 - fTemp342))) as i32;
			...
			let mut fTemp364: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp363, 3)) as usize] };
			...
			let mut fTemp370: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp369, 3)) as usize] };
			...
			let mut fTemp373: F64 = if iTemp63 != 0 {fTemp371 + fTemp77 * fTemp372 + (fTemp367 - (iTemp368) as F64) * (fTemp370 - (fTemp371 + fTemp77 * (fTemp372 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp369, 4)) as usize] } - fTemp370))))} else {1.0 - (fTemp365 + fTemp77 * fTemp366 + (fTemp361 - (iTemp362) as F64) * (fTemp364 - (fTemp365 + fTemp77 * (fTemp366 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp363, 4)) as usize] } - fTemp364)))))};
			...
			let mut fTemp378: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp377, 3)) as usize] };
			...
			let mut fTemp384: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp383, 3), 196607))) as usize] };
			let mut fTemp385: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp383 as usize] };
			let mut fTemp386: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp383, 1), 196607))) as usize] } - fTemp385;
			let mut iTemp387: i32 = (fTemp138 > ((if iTemp63 != 0 {fTemp385 + fTemp77 * fTemp386 + (fTemp381 - (iTemp382) as F64) * (fTemp384 - (fTemp385 + fTemp77 * (fTemp386 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp383, 4), 196607))) as usize] } - fTemp384))))} else {1.0 - (fTemp379 + fTemp77 * fTemp380 + (fTemp375 - (iTemp376) as F64) * (fTemp378 - (fTemp379 + fTemp77 * (fTemp380 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp377, 4)) as usize] } - fTemp378)))))} - fTemp373) / (1.0 - fTemp373))) as i32;
			...
			let mut fTemp395: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp394, 3)) as usize] };
			...
			let mut fTemp401: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp400, 3)) as usize] };
			...
			let mut fTemp404: F64 = if iTemp63 != 0 {fTemp402 + fTemp77 * fTemp403 + (fTemp398 - (iTemp399) as F64) * (fTemp401 - (fTemp402 + fTemp77 * (fTemp403 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp400, 4)) as usize] } - fTemp401))))} else {1.0 - (fTemp396 + fTemp77 * fTemp397 + (fTemp392 - (iTemp393) as F64) * (fTemp395 - (fTemp396 + fTemp77 * (fTemp397 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp394, 4)) as usize] } - fTemp395)))))};
			...
			let mut fTemp409: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp408, 3)) as usize] };
			...
			let mut fTemp415: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp414, 3), 196607))) as usize] };
			let mut fTemp416: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp414 as usize] };
			let mut fTemp417: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp414, 1), 196607))) as usize] } - fTemp416;
			let mut iTemp418: i32 = (fTemp138 > ((if iTemp63 != 0 {fTemp416 + fTemp77 * fTemp417 + (fTemp412 - (iTemp413) as F64) * (fTemp415 - (fTemp416 + fTemp77 * (fTemp417 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp414, 4), 196607))) as usize] } - fTemp415))))} else {1.0 - (fTemp410 + fTemp77 * fTemp411 + (fTemp406 - (iTemp407) as F64) * (fTemp409 - (fTemp410 + fTemp77 * (fTemp411 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp408, 4)) as usize] } - fTemp409)))))} - fTemp404) / (1.0 - fTemp404))) as i32;
			...
			let mut fTemp426: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp425, 3)) as usize] };
			...
			let mut fTemp432: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp431, 3)) as usize] };
			...
			let mut fTemp435: F64 = if iTemp63 != 0 {fTemp433 + fTemp77 * fTemp434 + (fTemp429 - (iTemp430) as F64) * (fTemp432 - (fTemp433 + fTemp77 * (fTemp434 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp431, 4)) as usize] } - fTemp432))))} else {1.0 - (fTemp427 + fTemp77 * fTemp428 + (fTemp423 - (iTemp424) as F64) * (fTemp426 - (fTemp427 + fTemp77 * (fTemp428 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp425, 4)) as usize] } - fTemp426)))))};
			...
			let mut fTemp440: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp439, 3)) as usize] };
			...
			let mut fTemp446: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp445, 3), 196607))) as usize] };
			let mut fTemp447: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp445 as usize] };
			let mut fTemp448: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp445, 1), 196607))) as usize] } - fTemp447;
			let mut iTemp449: i32 = (fTemp138 > ((if iTemp63 != 0 {fTemp447 + fTemp77 * fTemp448 + (fTemp443 - (iTemp444) as F64) * (fTemp446 - (fTemp447 + fTemp77 * (fTemp448 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp445, 4), 196607))) as usize] } - fTemp446))))} else {1.0 - (fTemp441 + fTemp77 * fTemp442 + (fTemp437 - (iTemp438) as F64) * (fTemp440 - (fTemp441 + fTemp77 * (fTemp442 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp439, 4)) as usize] } - fTemp440)))))} - fTemp435) / (1.0 - fTemp435))) as i32;
			...
			let mut fTemp457: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp456, 3)) as usize] };
			...
			let mut fTemp463: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp462, 3)) as usize] };
			...
			let mut fTemp466: F64 = if iTemp63 != 0 {fTemp464 + fTemp77 * fTemp465 + (fTemp460 - (iTemp461) as F64) * (fTemp463 - (fTemp464 + fTemp77 * (fTemp465 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp462, 4)) as usize] } - fTemp463))))} else {1.0 - (fTemp458 + fTemp77 * fTemp459 + (fTemp454 - (iTemp455) as F64) * (fTemp457 - (fTemp458 + fTemp77 * (fTemp459 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp456, 4)) as usize] } - fTemp457)))))};
			...
			let mut fTemp471: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp470, 3)) as usize] };
			...
			let mut fTemp477: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp476, 3), 196607))) as usize] };
			let mut fTemp478: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp476 as usize] };
			let mut fTemp479: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp476, 1), 196607))) as usize] } - fTemp478;
			let mut iTemp480: i32 = (fTemp138 > ((if iTemp63 != 0 {fTemp478 + fTemp77 * fTemp479 + (fTemp474 - (iTemp475) as F64) * (fTemp477 - (fTemp478 + fTemp77 * (fTemp479 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp476, 4), 196607))) as usize] } - fTemp477))))} else {1.0 - (fTemp472 + fTemp77 * fTemp473 + (fTemp468 - (iTemp469) as F64) * (fTemp471 - (fTemp472 + fTemp77 * (fTemp473 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp470, 4)) as usize] } - fTemp471)))))} - fTemp466) / (1.0 - fTemp466))) as i32;
			...
			let mut fTemp488: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp487, 3)) as usize] };
			...
			let mut fTemp494: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp493, 3)) as usize] };
			...
			let mut fTemp497: F64 = if iTemp63 != 0 {fTemp495 + fTemp77 * fTemp496 + (fTemp491 - (iTemp492) as F64) * (fTemp494 - (fTemp495 + fTemp77 * (fTemp496 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp493, 4)) as usize] } - fTemp494))))} else {1.0 - (fTemp489 + fTemp77 * fTemp490 + (fTemp485 - (iTemp486) as F64) * (fTemp488 - (fTemp489 + fTemp77 * (fTemp490 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp487, 4)) as usize] } - fTemp488)))))};
			...
			let mut fTemp502: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp501, 3)) as usize] };
			...
			let mut fTemp508: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp507, 3), 196607))) as usize] };
			let mut fTemp509: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp507 as usize] };
			let mut fTemp510: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp507, 1), 196607))) as usize] } - fTemp509;
			let mut iTemp511: i32 = (fTemp138 > ((if iTemp63 != 0 {fTemp509 + fTemp77 * fTemp510 + (fTemp505 - (iTemp506) as F64) * (fTemp508 - (fTemp509 + fTemp77 * (fTemp510 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp507, 4), 196607))) as usize] } - fTemp508))))} else {1.0 - (fTemp503 + fTemp77 * fTemp504 + (fTemp499 - (iTemp500) as F64) * (fTemp502 - (fTemp503 + fTemp77 * (fTemp504 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp501, 4)) as usize] } - fTemp502)))))} - fTemp497) / (1.0 - fTemp497))) as i32;
			...
			let mut fTemp519: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp518, 3)) as usize] };
			...
			let mut fTemp525: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp524, 3)) as usize] };
			...
			let mut fTemp528: F64 = if iTemp63 != 0 {fTemp526 + fTemp77 * fTemp527 + (fTemp522 - (iTemp523) as F64) * (fTemp525 - (fTemp526 + fTemp77 * (fTemp527 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp524, 4)) as usize] } - fTemp525))))} else {1.0 - (fTemp520 + fTemp77 * fTemp521 + (fTemp516 - (iTemp517) as F64) * (fTemp519 - (fTemp520 + fTemp77 * (fTemp521 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp518, 4)) as usize] } - fTemp519)))))};
			...
			let mut fTemp533: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp532, 3)) as usize] };
			...
			let mut fTemp539: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp538, 3), 196607))) as usize] };
			let mut fTemp540: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp538 as usize] };
			let mut fTemp541: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp538, 1), 196607))) as usize] } - fTemp540;
			let mut iTemp542: i32 = (fTemp138 > ((if iTemp63 != 0 {fTemp540 + fTemp77 * fTemp541 + (fTemp536 - (iTemp537) as F64) * (fTemp539 - (fTemp540 + fTemp77 * (fTemp541 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp538, 4), 196607))) as usize] } - fTemp539))))} else {1.0 - (fTemp534 + fTemp77 * fTemp535 + (fTemp530 - (iTemp531) as F64) * (fTemp533 - (fTemp534 + fTemp77 * (fTemp535 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp532, 4)) as usize] } - fTemp533)))))} - fTemp528) / (1.0 - fTemp528))) as i32;
			...
			let mut fTemp550: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp549, 3)) as usize] };
			...
			let mut fTemp556: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp555, 3)) as usize] };
			...
			let mut fTemp559: F64 = if iTemp63 != 0 {fTemp557 + fTemp77 * fTemp558 + (fTemp553 - (iTemp554) as F64) * (fTemp556 - (fTemp557 + fTemp77 * (fTemp558 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp555, 4)) as usize] } - fTemp556))))} else {1.0 - (fTemp551 + fTemp77 * fTemp552 + (fTemp547 - (iTemp548) as F64) * (fTemp550 - (fTemp551 + fTemp77 * (fTemp552 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp549, 4)) as usize] } - fTemp550)))))};
			...
			let mut fTemp564: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp563, 3)) as usize] };
			...
			let mut fTemp570: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp569, 3), 196607))) as usize] };
			let mut fTemp571: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp569 as usize] };
			let mut fTemp572: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp569, 1), 196607))) as usize] } - fTemp571;
			let mut iTemp573: i32 = (fTemp138 > ((if iTemp63 != 0 {fTemp571 + fTemp77 * fTemp572 + (fTemp567 - (iTemp568) as F64) * (fTemp570 - (fTemp571 + fTemp77 * (fTemp572 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp569, 4), 196607))) as usize] } - fTemp570))))} else {1.0 - (fTemp565 + fTemp77 * fTemp566 + (fTemp561 - (iTemp562) as F64) * (fTemp564 - (fTemp565 + fTemp77 * (fTemp566 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp563, 4)) as usize] } - fTemp564)))))} - fTemp559) / (1.0 - fTemp559))) as i32;
			...
			let mut fTemp581: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp580, 3)) as usize] };
			...
			let mut fTemp587: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp586, 3)) as usize] };
			...
			let mut fTemp590: F64 = if iTemp63 != 0 {fTemp588 + fTemp77 * fTemp589 + (fTemp584 - (iTemp585) as F64) * (fTemp587 - (fTemp588 + fTemp77 * (fTemp589 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp586, 4), 196607))) as usize] } - fTemp587))))} else {1.0 - (fTemp582 + fTemp77 * fTemp583 + (fTemp578 - (iTemp579) as F64) * (fTemp581 - (fTemp582 + fTemp77 * (fTemp583 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp580, 4), 196607))) as usize] } - fTemp581)))))};
			...
			let mut fTemp595: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp594, 3)) as usize] };
			...
			let mut fTemp601: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp600, 3), 196607))) as usize] };
			let mut fTemp602: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp600 as usize] };
			let mut fTemp603: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp600, 1), 196607))) as usize] } - fTemp602;
			let mut iTemp604: i32 = (fTemp138 > ((if iTemp63 != 0 {fTemp602 + fTemp77 * fTemp603 + (fTemp598 - (iTemp599) as F64) * (fTemp601 - (fTemp602 + fTemp77 * (fTemp603 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp600, 4), 196607))) as usize] } - fTemp601))))} else {1.0 - (fTemp596 + fTemp77 * fTemp597 + (fTemp592 - (iTemp593) as F64) * (fTemp595 - (fTemp596 + fTemp77 * (fTemp597 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp594, 4)) as usize] } - fTemp595)))))} - fTemp590) / (1.0 - fTemp590))) as i32;
			...
			let mut fTemp609: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp608, 3)) as usize] };
			let mut fTemp610: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp608 as usize] };
			let mut fTemp611: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp608, 1)) as usize] } - fTemp610;
			...
			let mut fTemp615: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp614, 3)) as usize] };
			let mut fTemp616: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp614 as usize] };
			let mut fTemp617: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp614, 1)) as usize] } - fTemp616;
			let mut fTemp618: F64 = if iTemp63 != 0 {fTemp616 + fTemp77 * fTemp617 + (fTemp612 - (iTemp613) as F64) * (fTemp615 - (fTemp616 + fTemp77 * (fTemp617 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp614, 4), 196607))) as usize] } - fTemp615))))} else {1.0 - (fTemp610 + fTemp77 * fTemp611 + (fTemp606 - (iTemp607) as F64) * (fTemp609 - (fTemp610 + fTemp77 * (fTemp611 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp608, 4), 196607))) as usize] } - fTemp609)))))};
			...
			let mut fTemp623: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp622, 3)) as usize] };
			let mut fTemp624: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp622 as usize] };
			let mut fTemp625: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp622, 1)) as usize] } - fTemp624;
			...
			let mut fTemp629: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp628, 3), 196607))) as usize] };
			let mut fTemp630: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp628 as usize] };
			let mut fTemp631: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp628, 1), 196607))) as usize] } - fTemp630;
			let mut fTemp632: F64 = fTemp5 + if ((0.001 * fTemp81) == 0.0) as i32 != 0 {fTemp62} else {fTemp62 * (if iTemp63 != 0 {fTemp630 + fTemp77 * fTemp631 + (fTemp626 - (iTemp627) as F64) * (fTemp629 - (fTemp630 + fTemp77 * (fTemp631 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp628, 4), 196607))) as usize] } - fTemp629))))} else {1.0 - (fTemp624 + fTemp77 * fTemp625 + (fTemp620 - (iTemp621) as F64) * (fTemp623 - (fTemp624 + fTemp77 * (fTemp625 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp622, 4)) as usize] } - fTemp623)))))} - fTemp618) / (1.0 - fTemp618)};
			self.fRec2[(self.IOTA0 & 8191) as usize] = if iTemp80 != 0 {F64::min(fTemp632, fTemp5)} else {F64::max(fTemp632, fTemp5)};
			let mut fTemp633: F64 = self.fRec2[((i32::wrapping_sub(self.IOTA0, iSlow71)) & 8191) as usize];
			self.fRec14[0] = fSlow72 + self.fConst4 * self.fRec14[1];
			*output0 = 0.5 * self.fVec1[((i32::wrapping_sub(self.IOTA0, iSlow18)) & 32767) as usize] * fTemp2 + self.fRec14[0] * self.fVec2[((i32::wrapping_sub(self.IOTA0, iSlow18)) & 32767) as usize] * fTemp633 * fTemp4;
			let mut fTemp634: F64 = self.fRec16[((i32::wrapping_sub(self.IOTA0, 1)) & 8191) as usize];
			let mut fTemp635: F64 = fTemp36 + fSlow21 * (fTemp37 - fTemp36);
			let mut iTemp636: i32 = ((fTemp635 > fSlow11) as i32) + ((fTemp635 > fSlow9) as i32);
			let mut fTemp637: F64 = fTemp635 - fSlow8;
			let mut fTemp638: F64 = F64::min(fTemp34, F64::powf(1e+01, -(fSlow22 * F64::max(0.0, if (iTemp636 == 0) as i32 != 0 {0.0} else {if (iTemp636 == 1) as i32 != 0 {fSlow12 * LambRs48k_faustpower2_f(fSlow7 + fTemp637)} else {fTemp637}}))));
			self.fVec31[(self.IOTA0 & 16383) as usize] = fTemp638;
			let mut fTemp639: F64 = F64::min(fTemp638, self.fVec31[((i32::wrapping_sub(self.IOTA0, 1)) & 16383) as usize]);
			self.fVec32[0] = fTemp639;
			let mut fTemp640: F64 = F64::min(fTemp639, self.fVec32[2]);
			self.fVec33[0] = fTemp640;
			let mut fTemp641: F64 = F64::min(fTemp640, self.fVec33[4]);
			self.fVec34[0] = fTemp641;
			let mut fTemp642: F64 = F64::min(fTemp641, self.fVec34[8]);
			self.fVec35[(self.IOTA0 & 31) as usize] = fTemp642;
			let mut fTemp643: F64 = F64::min(fTemp642, self.fVec35[((i32::wrapping_sub(self.IOTA0, 16)) & 31) as usize]);
			self.fVec36[(self.IOTA0 & 63) as usize] = fTemp643;
			let mut fTemp644: F64 = F64::min(fTemp643, self.fVec36[((i32::wrapping_sub(self.IOTA0, 32)) & 63) as usize]);
			self.fVec37[(self.IOTA0 & 127) as usize] = fTemp644;
			let mut fTemp645: F64 = F64::min(fTemp644, self.fVec37[((i32::wrapping_sub(self.IOTA0, 64)) & 127) as usize]);
			self.fVec38[(self.IOTA0 & 255) as usize] = fTemp645;
			let mut fTemp646: F64 = F64::min(fTemp645, self.fVec38[((i32::wrapping_sub(self.IOTA0, 128)) & 255) as usize]);
			self.fVec39[(self.IOTA0 & 511) as usize] = fTemp646;
			let mut fTemp647: F64 = F64::min(fTemp646, self.fVec39[((i32::wrapping_sub(self.IOTA0, 256)) & 511) as usize]);
			self.fVec40[(self.IOTA0 & 1023) as usize] = fTemp647;
			let mut fTemp648: F64 = F64::min(fTemp647, self.fVec40[((i32::wrapping_sub(self.IOTA0, 512)) & 1023) as usize]);
			self.fVec41[(self.IOTA0 & 2047) as usize] = fTemp648;
			self.fVec42[(self.IOTA0 & 4095) as usize] = F64::min(fTemp648, self.fVec41[((i32::wrapping_sub(self.IOTA0, 1024)) & 2047) as usize]);
			self.fRec17[0] = F64::max(F64::min(self.fRec17[1], self.fVec31[((i32::wrapping_sub(self.IOTA0, iSlow24)) & 16383) as usize]), F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(if iSlow26 != 0 {fTemp638} else {1.7976931348623157e+308}, if iSlow27 != 0 {self.fVec32[iSlow26 as usize]} else {1.7976931348623157e+308}), if iSlow28 != 0 {self.fVec33[iSlow29 as usize]} else {1.7976931348623157e+308}), if iSlow30 != 0 {self.fVec34[iSlow31 as usize]} else {1.7976931348623157e+308}), if iSlow32 != 0 {self.fVec35[((i32::wrapping_sub(self.IOTA0, iSlow33)) & 31) as usize]} else {1.7976931348623157e+308}), if iSlow34 != 0 {self.fVec36[((i32::wrapping_sub(self.IOTA0, iSlow35)) & 63) as usize]} else {1.7976931348623157e+308}), if iSlow36 != 0 {self.fVec37[((i32::wrapping_sub(self.IOTA0, iSlow37)) & 127) as usize]} else {1.7976931348623157e+308}), if iSlow38 != 0 {self.fVec38[((i32::wrapping_sub(self.IOTA0, iSlow39)) & 255) as usize]} else {1.7976931348623157e+308}), if iSlow40 != 0 {self.fVec39[((i32::wrapping_sub(self.IOTA0, iSlow41)) & 511) as usize]} else {1.7976931348623157e+308}), if iSlow42 != 0 {self.fVec40[((i32::wrapping_sub(self.IOTA0, iSlow43)) & 1023) as usize]} else {1.7976931348623157e+308}), if iSlow44 != 0 {self.fVec41[((i32::wrapping_sub(self.IOTA0, iSlow45)) & 2047) as usize]} else {1.7976931348623157e+308}), if iSlow46 != 0 {self.fVec42[((i32::wrapping_sub(self.IOTA0, iSlow47)) & 4095) as usize]} else {1.7976931348623157e+308}));
			let mut fTemp649: F64 = F64::min(self.fRec17[0], self.fRec17[1]);
			self.fVec43[0] = fTemp649;
			let mut fTemp650: F64 = F64::min(fTemp649, self.fVec43[2]);
			self.fVec44[0] = fTemp650;
			let mut fTemp651: F64 = F64::min(fTemp650, self.fVec44[4]);
			self.fVec45[0] = fTemp651;
			let mut fTemp652: F64 = F64::min(fTemp651, self.fVec45[8]);
			self.fVec46[(self.IOTA0 & 31) as usize] = fTemp652;
			let mut fTemp653: F64 = F64::min(fTemp652, self.fVec46[((i32::wrapping_sub(self.IOTA0, 16)) & 31) as usize]);
			self.fVec47[(self.IOTA0 & 63) as usize] = fTemp653;
			let mut fTemp654: F64 = F64::min(fTemp653, self.fVec47[((i32::wrapping_sub(self.IOTA0, 32)) & 63) as usize]);
			self.fVec48[(self.IOTA0 & 127) as usize] = fTemp654;
			let mut fTemp655: F64 = F64::min(fTemp654, self.fVec48[((i32::wrapping_sub(self.IOTA0, 64)) & 127) as usize]);
			self.fVec49[(self.IOTA0 & 255) as usize] = fTemp655;
			let mut fTemp656: F64 = F64::min(fTemp655, self.fVec49[((i32::wrapping_sub(self.IOTA0, 128)) & 255) as usize]);
			self.fVec50[(self.IOTA0 & 511) as usize] = fTemp656;
			let mut fTemp657: F64 = F64::min(fTemp656, self.fVec50[((i32::wrapping_sub(self.IOTA0, 256)) & 511) as usize]);
			self.fVec51[(self.IOTA0 & 1023) as usize] = fTemp657;
			let mut fTemp658: F64 = F64::min(fTemp657, self.fVec51[((i32::wrapping_sub(self.IOTA0, 512)) & 1023) as usize]);
			self.fVec52[(self.IOTA0 & 2047) as usize] = fTemp658;
			self.fVec53[(self.IOTA0 & 4095) as usize] = F64::min(fTemp658, self.fVec52[((i32::wrapping_sub(self.IOTA0, 1024)) & 2047) as usize]);
			let mut fTemp659: F64 = F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(if iSlow4 != 0 {self.fRec17[0]} else {1.7976931348623157e+308}, if iSlow48 != 0 {self.fVec43[iSlow4 as usize]} else {1.7976931348623157e+308}), if iSlow49 != 0 {self.fVec44[iSlow50 as usize]} else {1.7976931348623157e+308}), if iSlow51 != 0 {self.fVec45[iSlow52 as usize]} else {1.7976931348623157e+308}), if iSlow53 != 0 {self.fVec46[((i32::wrapping_sub(self.IOTA0, iSlow54)) & 31) as usize]} else {1.7976931348623157e+308}), if iSlow55 != 0 {self.fVec47[((i32::wrapping_sub(self.IOTA0, iSlow56)) & 63) as usize]} else {1.7976931348623157e+308}), if iSlow57 != 0 {self.fVec48[((i32::wrapping_sub(self.IOTA0, iSlow58)) & 127) as usize]} else {1.7976931348623157e+308}), if iSlow59 != 0 {self.fVec49[((i32::wrapping_sub(self.IOTA0, iSlow60)) & 255) as usize]} else {1.7976931348623157e+308}), if iSlow61 != 0 {self.fVec50[((i32::wrapping_sub(self.IOTA0, iSlow62)) & 511) as usize]} else {1.7976931348623157e+308}), if iSlow63 != 0 {self.fVec51[((i32::wrapping_sub(self.IOTA0, iSlow64)) & 1023) as usize]} else {1.7976931348623157e+308}), if iSlow65 != 0 {self.fVec52[((i32::wrapping_sub(self.IOTA0, iSlow66)) & 2047) as usize]} else {1.7976931348623157e+308}), if iSlow67 != 0 {self.fVec53[((i32::wrapping_sub(self.IOTA0, iSlow68)) & 4095) as usize]} else {1.7976931348623157e+308}) - fTemp634;
			self.fVec54[0] = fTemp659;
			let mut iTemp660: i32 = (fTemp659 > 0.0) as i32;
			let mut fTemp661: F64 = if iTemp660 != 0 {fSlow70} else {fSlow69};
			self.fVec55[0] = fTemp661;
			...
			let mut fTemp666: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp665, 3)) as usize] };
			let mut fTemp667: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp665 as usize] };
			let mut fTemp668: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp665, 1)) as usize] } - fTemp667;
			let mut fTemp669: F64 = fTemp662 - (iTemp663) as F64;
			let mut fTemp670: F64 = fTemp667 + fTemp669 * fTemp668 + 0.5 * (fTemp666 - (fTemp667 + fTemp669 * (fTemp668 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp665, 4)) as usize] } - fTemp666))));
			...
			let mut fTemp679: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp678, 3)) as usize] };
			let mut fTemp680: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp678 as usize] };
			let mut fTemp681: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp678, 1)) as usize] } - fTemp680;
			...
			let mut fTemp685: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp684, 3), 196607))) as usize] };
			let mut fTemp686: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp684 as usize] };
			let mut fTemp687: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp684, 1), 196607))) as usize] } - fTemp686;
			let mut fTemp688: F64 = 2.0 * self.fVec55[1];
			...
			let mut fTemp694: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp693, 3), 196607))) as usize] };
			let mut fTemp695: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp693 as usize] };
			let mut fTemp696: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp693, 1), 196607))) as usize] } - fTemp695;
			...
			let mut fTemp701: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp700, 3), 196607))) as usize] };
			let mut fTemp702: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp700 as usize] };
			let mut fTemp703: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp700, 1), 196607))) as usize] } - fTemp702;
			...
			let mut fTemp708: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp707, 3)) as usize] };
			let mut fTemp709: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp707 as usize] };
			let mut fTemp710: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp707, 1)) as usize] } - fTemp709;
			...
			let mut fTemp714: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp713, 3), 196607))) as usize] };
			let mut fTemp715: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp713 as usize] };
			let mut fTemp716: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp713, 1), 196607))) as usize] } - fTemp715;
			let mut fTemp717: F64 = self.fRec15[1] + self.fConst10 * (1.0 / fTemp673 + 1.0 / self.fVec56[1]);
			...
			let mut fTemp721: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp720, 3)) as usize] };
			let mut fTemp722: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp720 as usize] };
			let mut fTemp723: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp720, 1)) as usize] } - fTemp722;
			...
			let mut fTemp727: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp726, 3), 196607))) as usize] };
			let mut fTemp728: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp726 as usize] };
			let mut fTemp729: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp726, 1), 196607))) as usize] } - fTemp728;
			let mut fTemp730: F64 = (if iTemp660 != 0 {fTemp728 + fTemp669 * fTemp729 + (fTemp724 - (iTemp725) as F64) * (fTemp727 - (fTemp728 + fTemp669 * (fTemp729 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp726, 4), 196607))) as usize] } - fTemp727))))} else {1.0 - (fTemp722 + fTemp669 * fTemp723 + (fTemp718 - (iTemp719) as F64) * (fTemp721 - (fTemp722 + fTemp669 * (fTemp723 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp720, 4)) as usize] } - fTemp721)))))} - if iTemp660 != 0 {fTemp715 + fTemp669 * fTemp716 + (fTemp711 - (iTemp712) as F64) * (fTemp714 - (fTemp715 + fTemp669 * (fTemp716 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp713, 4), 196607))) as usize] } - fTemp714))))} else {1.0 - (fTemp709 + fTemp669 * fTemp710 + (fTemp705 - (iTemp706) as F64) * (fTemp708 - (fTemp709 + fTemp669 * (fTemp710 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp707, 4), 196607))) as usize] } - fTemp708)))))}) * self.fVec54[1] / (fTemp659 * (1.0 - if iTemp660 != 0 {fTemp702 + fTemp697 * fTemp703 + (fTemp698 - (iTemp699) as F64) * (fTemp701 - (fTemp702 + fTemp697 * (fTemp703 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp700, 4), 196607))) as usize] } - fTemp701))))} else {1.0 - (fTemp695 + fTemp697 * fTemp696 + (fTemp691 - (iTemp692) as F64) * (fTemp694 - (fTemp695 + fTemp697 * (fTemp696 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp693, 4), 196607))) as usize] } - fTemp694)))))}));
			let mut iTemp731: i32 = (fTemp730 > ((if iTemp660 != 0 {fTemp686 + fTemp669 * fTemp687 + (fTemp682 - (iTemp683) as F64) * (fTemp685 - (fTemp686 + fTemp669 * (fTemp687 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp684, 4), 196607))) as usize] } - fTemp685))))} else {1.0 - (fTemp680 + fTemp669 * fTemp681 + (fTemp676 - (iTemp677) as F64) * (fTemp679 - (fTemp680 + fTemp669 * (fTemp681 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp678, 4)) as usize] } - fTemp679)))))} - fTemp671) / (1.0 - fTemp671))) as i32;
			...
			let mut fTemp739: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp738, 3)) as usize] };
			let mut fTemp740: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp738 as usize] };
			let mut fTemp741: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp738, 1)) as usize] } - fTemp740;
			...
			let mut fTemp745: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp744, 3)) as usize] };
			let mut fTemp746: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp744 as usize] };
			let mut fTemp747: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp744, 1)) as usize] } - fTemp746;
			let mut fTemp748: F64 = if iTemp660 != 0 {fTemp746 + fTemp669 * fTemp747 + (fTemp742 - (iTemp743) as F64) * (fTemp745 - (fTemp746 + fTemp669 * (fTemp747 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp744, 4)) as usize] } - fTemp745))))} else {1.0 - (fTemp740 + fTemp669 * fTemp741 + (fTemp736 - (iTemp737) as F64) * (fTemp739 - (fTemp740 + fTemp669 * (fTemp741 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp738, 4)) as usize] } - fTemp739)))))};
			...
			let mut fTemp753: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp752, 3)) as usize] };
			let mut fTemp754: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp752 as usize] };
			let mut fTemp755: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp752, 1)) as usize] } - fTemp754;
			...
			let mut fTemp759: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp758, 3), 196607))) as usize] };
			let mut fTemp760: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp758 as usize] };
			let mut fTemp761: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp758, 1), 196607))) as usize] } - fTemp760;
			let mut iTemp762: i32 = (fTemp730 > ((if iTemp660 != 0 {fTemp760 + fTemp669 * fTemp761 + (fTemp756 - (iTemp757) as F64) * (fTemp759 - (fTemp760 + fTemp669 * (fTemp761 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp758, 4), 196607))) as usize] } - fTemp759))))} else {1.0 - (fTemp754 + fTemp669 * fTemp755 + (fTemp750 - (iTemp751) as F64) * (fTemp753 - (fTemp754 + fTemp669 * (fTemp755 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp752, 4)) as usize] } - fTemp753)))))} - fTemp748) / (1.0 - fTemp748))) as i32;
			...
			let mut fTemp770: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp769, 3)) as usize] };
			let mut fTemp771: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp769 as usize] };
			let mut fTemp772: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp769, 1)) as usize] } - fTemp771;
			...
			let mut fTemp776: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp775, 3)) as usize] };
			let mut fTemp777: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp775 as usize] };
			let mut fTemp778: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp775, 1)) as usize] } - fTemp777;
			let mut fTemp779: F64 = if iTemp660 != 0 {fTemp777 + fTemp669 * fTemp778 + (fTemp773 - (iTemp774) as F64) * (fTemp776 - (fTemp777 + fTemp669 * (fTemp778 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp775, 4)) as usize] } - fTemp776))))} else {1.0 - (fTemp771 + fTemp669 * fTemp772 + (fTemp767 - (iTemp768) as F64) * (fTemp770 - (fTemp771 + fTemp669 * (fTemp772 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp769, 4)) as usize] } - fTemp770)))))};
			...
			let mut fTemp784: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp783, 3)) as usize] };
			let mut fTemp785: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp783 as usize] };
			let mut fTemp786: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp783, 1)) as usize] } - fTemp785;
			...
			let mut fTemp790: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp789, 3), 196607))) as usize] };
			let mut fTemp791: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp789 as usize] };
			let mut fTemp792: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp789, 1), 196607))) as usize] } - fTemp791;
			let mut iTemp793: i32 = (fTemp730 > ((if iTemp660 != 0 {fTemp791 + fTemp669 * fTemp792 + (fTemp787 - (iTemp788) as F64) * (fTemp790 - (fTemp791 + fTemp669 * (fTemp792 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp789, 4), 196607))) as usize] } - fTemp790))))} else {1.0 - (fTemp785 + fTemp669 * fTemp786 + (fTemp781 - (iTemp782) as F64) * (fTemp784 - (fTemp785 + fTemp669 * (fTemp786 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp783, 4)) as usize] } - fTemp784)))))} - fTemp779) / (1.0 - fTemp779))) as i32;
			...
			let mut fTemp801: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp800, 3)) as usize] };
			let mut fTemp802: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp800 as usize] };
			let mut fTemp803: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp800, 1)) as usize] } - fTemp802;
			...
			let mut fTemp807: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp806, 3)) as usize] };
			let mut fTemp808: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp806 as usize] };
			let mut fTemp809: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp806, 1)) as usize] } - fTemp808;
			let mut fTemp810: F64 = if iTemp660 != 0 {fTemp808 + fTemp669 * fTemp809 + (fTemp804 - (iTemp805) as F64) * (fTemp807 - (fTemp808 + fTemp669 * (fTemp809 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp806, 4)) as usize] } - fTemp807))))} else {1.0 - (fTemp802 + fTemp669 * fTemp803 + (fTemp798 - (iTemp799) as F64) * (fTemp801 - (fTemp802 + fTemp669 * (fTemp803 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp800, 4)) as usize] } - fTemp801)))))};
			...
			let mut fTemp815: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp814, 3)) as usize] };
			let mut fTemp816: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp814 as usize] };
			let mut fTemp817: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp814, 1)) as usize] } - fTemp816;
			...
			let mut fTemp821: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp820, 3), 196607))) as usize] };
			let mut fTemp822: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp820 as usize] };
			let mut fTemp823: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp820, 1), 196607))) as usize] } - fTemp822;
			let mut iTemp824: i32 = (fTemp730 > ((if iTemp660 != 0 {fTemp822 + fTemp669 * fTemp823 + (fTemp818 - (iTemp819) as F64) * (fTemp821 - (fTemp822 + fTemp669 * (fTemp823 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp820, 4), 196607))) as usize] } - fTemp821))))} else {1.0 - (fTemp816 + fTemp669 * fTemp817 + (fTemp812 - (iTemp813) as F64) * (fTemp815 - (fTemp816 + fTemp669 * (fTemp817 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp814, 4)) as usize] } - fTemp815)))))} - fTemp810) / (1.0 - fTemp810))) as i32;
			...
			let mut fTemp832: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp831, 3)) as usize] };
			let mut fTemp833: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp831 as usize] };
			let mut fTemp834: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp831, 1)) as usize] } - fTemp833;
			...
			let mut fTemp838: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp837, 3)) as usize] };
			let mut fTemp839: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp837 as usize] };
			let mut fTemp840: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp837, 1)) as usize] } - fTemp839;
			let mut fTemp841: F64 = if iTemp660 != 0 {fTemp839 + fTemp669 * fTemp840 + (fTemp835 - (iTemp836) as F64) * (fTemp838 - (fTemp839 + fTemp669 * (fTemp840 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp837, 4)) as usize] } - fTemp838))))} else {1.0 - (fTemp833 + fTemp669 * fTemp834 + (fTemp829 - (iTemp830) as F64) * (fTemp832 - (fTemp833 + fTemp669 * (fTemp834 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp831, 4)) as usize] } - fTemp832)))))};
			...
			let mut fTemp846: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp845, 3)) as usize] };
			let mut fTemp847: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp845 as usize] };
			let mut fTemp848: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp845, 1)) as usize] } - fTemp847;
			...
			let mut fTemp852: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp851, 3), 196607))) as usize] };
			let mut fTemp853: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp851 as usize] };
			let mut fTemp854: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp851, 1), 196607))) as usize] } - fTemp853;
			let mut iTemp855: i32 = (fTemp730 > ((if iTemp660 != 0 {fTemp853 + fTemp669 * fTemp854 + (fTemp849 - (iTemp850) as F64) * (fTemp852 - (fTemp853 + fTemp669 * (fTemp854 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp851, 4), 196607))) as usize] } - fTemp852))))} else {1.0 - (fTemp847 + fTemp669 * fTemp848 + (fTemp843 - (iTemp844) as F64) * (fTemp846 - (fTemp847 + fTemp669 * (fTemp848 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp845, 4)) as usize] } - fTemp846)))))} - fTemp841) / (1.0 - fTemp841))) as i32;
			...
			let mut fTemp863: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp862, 3)) as usize] };
			let mut fTemp864: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp862 as usize] };
			let mut fTemp865: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp862, 1)) as usize] } - fTemp864;
			...
			let mut fTemp869: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp868, 3)) as usize] };
			let mut fTemp870: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp868 as usize] };
			let mut fTemp871: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp868, 1)) as usize] } - fTemp870;
			let mut fTemp872: F64 = if iTemp660 != 0 {fTemp870 + fTemp669 * fTemp871 + (fTemp866 - (iTemp867) as F64) * (fTemp869 - (fTemp870 + fTemp669 * (fTemp871 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp868, 4)) as usize] } - fTemp869))))} else {1.0 - (fTemp864 + fTemp669 * fTemp865 + (fTemp860 - (iTemp861) as F64) * (fTemp863 - (fTemp864 + fTemp669 * (fTemp865 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp862, 4)) as usize] } - fTemp863)))))};
			...
			let mut fTemp877: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp876, 3)) as usize] };
			let mut fTemp878: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp876 as usize] };
			let mut fTemp879: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp876, 1)) as usize] } - fTemp878;
			...
			let mut fTemp883: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp882, 3), 196607))) as usize] };
			let mut fTemp884: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp882 as usize] };
			let mut fTemp885: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp882, 1), 196607))) as usize] } - fTemp884;
			let mut iTemp886: i32 = (fTemp730 > ((if iTemp660 != 0 {fTemp884 + fTemp669 * fTemp885 + (fTemp880 - (iTemp881) as F64) * (fTemp883 - (fTemp884 + fTemp669 * (fTemp885 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp882, 4), 196607))) as usize] } - fTemp883))))} else {1.0 - (fTemp878 + fTemp669 * fTemp879 + (fTemp874 - (iTemp875) as F64) * (fTemp877 - (fTemp878 + fTemp669 * (fTemp879 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp876, 4)) as usize] } - fTemp877)))))} - fTemp872) / (1.0 - fTemp872))) as i32;
			...
			let mut fTemp894: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp893, 3)) as usize] };
			let mut fTemp895: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp893 as usize] };
			let mut fTemp896: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp893, 1)) as usize] } - fTemp895;
			...
			let mut fTemp900: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp899, 3)) as usize] };
			let mut fTemp901: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp899 as usize] };
			let mut fTemp902: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp899, 1)) as usize] } - fTemp901;
			let mut fTemp903: F64 = if iTemp660 != 0 {fTemp901 + fTemp669 * fTemp902 + (fTemp897 - (iTemp898) as F64) * (fTemp900 - (fTemp901 + fTemp669 * (fTemp902 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp899, 4)) as usize] } - fTemp900))))} else {1.0 - (fTemp895 + fTemp669 * fTemp896 + (fTemp891 - (iTemp892) as F64) * (fTemp894 - (fTemp895 + fTemp669 * (fTemp896 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp893, 4)) as usize] } - fTemp894)))))};
			...
			let mut fTemp908: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp907, 3)) as usize] };
			let mut fTemp909: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp907 as usize] };
			let mut fTemp910: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp907, 1)) as usize] } - fTemp909;
			...
			let mut fTemp914: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp913, 3), 196607))) as usize] };
			let mut fTemp915: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp913 as usize] };
			let mut fTemp916: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp913, 1), 196607))) as usize] } - fTemp915;
			let mut iTemp917: i32 = (fTemp730 > ((if iTemp660 != 0 {fTemp915 + fTemp669 * fTemp916 + (fTemp911 - (iTemp912) as F64) * (fTemp914 - (fTemp915 + fTemp669 * (fTemp916 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp913, 4), 196607))) as usize] } - fTemp914))))} else {1.0 - (fTemp909 + fTemp669 * fTemp910 + (fTemp905 - (iTemp906) as F64) * (fTemp908 - (fTemp909 + fTemp669 * (fTemp910 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp907, 4)) as usize] } - fTemp908)))))} - fTemp903) / (1.0 - fTemp903))) as i32;
			...
			let mut fTemp925: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp924, 3)) as usize] };
			let mut fTemp926: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp924 as usize] };
			let mut fTemp927: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp924, 1)) as usize] } - fTemp926;
			...
			let mut fTemp931: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp930, 3)) as usize] };
			let mut fTemp932: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp930 as usize] };
			let mut fTemp933: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp930, 1)) as usize] } - fTemp932;
			let mut fTemp934: F64 = if iTemp660 != 0 {fTemp932 + fTemp669 * fTemp933 + (fTemp928 - (iTemp929) as F64) * (fTemp931 - (fTemp932 + fTemp669 * (fTemp933 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp930, 4)) as usize] } - fTemp931))))} else {1.0 - (fTemp926 + fTemp669 * fTemp927 + (fTemp922 - (iTemp923) as F64) * (fTemp925 - (fTemp926 + fTemp669 * (fTemp927 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp924, 4)) as usize] } - fTemp925)))))};
			...
			let mut fTemp939: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp938, 3)) as usize] };
			let mut fTemp940: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp938 as usize] };
			let mut fTemp941: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp938, 1)) as usize] } - fTemp940;
			...
			let mut fTemp945: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp944, 3), 196607))) as usize] };
			let mut fTemp946: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp944 as usize] };
			let mut fTemp947: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp944, 1), 196607))) as usize] } - fTemp946;
			let mut iTemp948: i32 = (fTemp730 > ((if iTemp660 != 0 {fTemp946 + fTemp669 * fTemp947 + (fTemp942 - (iTemp943) as F64) * (fTemp945 - (fTemp946 + fTemp669 * (fTemp947 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp944, 4), 196607))) as usize] } - fTemp945))))} else {1.0 - (fTemp940 + fTemp669 * fTemp941 + (fTemp936 - (iTemp937) as F64) * (fTemp939 - (fTemp940 + fTemp669 * (fTemp941 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp938, 4)) as usize] } - fTemp939)))))} - fTemp934) / (1.0 - fTemp934))) as i32;
			...
			let mut fTemp956: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp955, 3)) as usize] };
			let mut fTemp957: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp955 as usize] };
			let mut fTemp958: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp955, 1)) as usize] } - fTemp957;
			...
			let mut fTemp962: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp961, 3)) as usize] };
			let mut fTemp963: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp961 as usize] };
			let mut fTemp964: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp961, 1)) as usize] } - fTemp963;
			let mut fTemp965: F64 = if iTemp660 != 0 {fTemp963 + fTemp669 * fTemp964 + (fTemp959 - (iTemp960) as F64) * (fTemp962 - (fTemp963 + fTemp669 * (fTemp964 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp961, 4)) as usize] } - fTemp962))))} else {1.0 - (fTemp957 + fTemp669 * fTemp958 + (fTemp953 - (iTemp954) as F64) * (fTemp956 - (fTemp957 + fTemp669 * (fTemp958 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp955, 4)) as usize] } - fTemp956)))))};
			...
			let mut fTemp970: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp969, 3)) as usize] };
			let mut fTemp971: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp969 as usize] };
			let mut fTemp972: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp969, 1)) as usize] } - fTemp971;
			...
			let mut fTemp976: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp975, 3), 196607))) as usize] };
			let mut fTemp977: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp975 as usize] };
			let mut fTemp978: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp975, 1), 196607))) as usize] } - fTemp977;
			let mut iTemp979: i32 = (fTemp730 > ((if iTemp660 != 0 {fTemp977 + fTemp669 * fTemp978 + (fTemp973 - (iTemp974) as F64) * (fTemp976 - (fTemp977 + fTemp669 * (fTemp978 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp975, 4), 196607))) as usize] } - fTemp976))))} else {1.0 - (fTemp971 + fTemp669 * fTemp972 + (fTemp967 - (iTemp968) as F64) * (fTemp970 - (fTemp971 + fTemp669 * (fTemp972 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp969, 4)) as usize] } - fTemp970)))))} - fTemp965) / (1.0 - fTemp965))) as i32;
			...
			let mut fTemp987: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp986, 3)) as usize] };
			let mut fTemp988: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp986 as usize] };
			let mut fTemp989: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp986, 1)) as usize] } - fTemp988;
			...
			let mut fTemp993: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp992, 3)) as usize] };
			let mut fTemp994: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp992 as usize] };
			let mut fTemp995: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp992, 1)) as usize] } - fTemp994;
			let mut fTemp996: F64 = if iTemp660 != 0 {fTemp994 + fTemp669 * fTemp995 + (fTemp990 - (iTemp991) as F64) * (fTemp993 - (fTemp994 + fTemp669 * (fTemp995 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp992, 4)) as usize] } - fTemp993))))} else {1.0 - (fTemp988 + fTemp669 * fTemp989 + (fTemp984 - (iTemp985) as F64) * (fTemp987 - (fTemp988 + fTemp669 * (fTemp989 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp986, 4)) as usize] } - fTemp987)))))};
			...
			let mut fTemp1001: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1000, 3)) as usize] };
			let mut fTemp1002: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1000 as usize] };
			let mut fTemp1003: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1000, 1)) as usize] } - fTemp1002;
			...
			let mut fTemp1007: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1006, 3), 196607))) as usize] };
			let mut fTemp1008: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1006 as usize] };
			let mut fTemp1009: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1006, 1), 196607))) as usize] } - fTemp1008;
			let mut iTemp1010: i32 = (fTemp730 > ((if iTemp660 != 0 {fTemp1008 + fTemp669 * fTemp1009 + (fTemp1004 - (iTemp1005) as F64) * (fTemp1007 - (fTemp1008 + fTemp669 * (fTemp1009 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1006, 4), 196607))) as usize] } - fTemp1007))))} else {1.0 - (fTemp1002 + fTemp669 * fTemp1003 + (fTemp998 - (iTemp999) as F64) * (fTemp1001 - (fTemp1002 + fTemp669 * (fTemp1003 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1000, 4)) as usize] } - fTemp1001)))))} - fTemp996) / (1.0 - fTemp996))) as i32;
			...
			let mut fTemp1018: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1017, 3)) as usize] };
			let mut fTemp1019: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1017 as usize] };
			let mut fTemp1020: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1017, 1)) as usize] } - fTemp1019;
			...
			let mut fTemp1024: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1023, 3)) as usize] };
			let mut fTemp1025: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1023 as usize] };
			let mut fTemp1026: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1023, 1)) as usize] } - fTemp1025;
			let mut fTemp1027: F64 = if iTemp660 != 0 {fTemp1025 + fTemp669 * fTemp1026 + (fTemp1021 - (iTemp1022) as F64) * (fTemp1024 - (fTemp1025 + fTemp669 * (fTemp1026 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1023, 4)) as usize] } - fTemp1024))))} else {1.0 - (fTemp1019 + fTemp669 * fTemp1020 + (fTemp1015 - (iTemp1016) as F64) * (fTemp1018 - (fTemp1019 + fTemp669 * (fTemp1020 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1017, 4)) as usize] } - fTemp1018)))))};
			...
			let mut fTemp1032: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1031, 3)) as usize] };
			let mut fTemp1033: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1031 as usize] };
			let mut fTemp1034: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1031, 1)) as usize] } - fTemp1033;
			...
			let mut fTemp1038: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1037, 3), 196607))) as usize] };
			let mut fTemp1039: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1037 as usize] };
			let mut fTemp1040: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1037, 1), 196607))) as usize] } - fTemp1039;
			let mut iTemp1041: i32 = (fTemp730 > ((if iTemp660 != 0 {fTemp1039 + fTemp669 * fTemp1040 + (fTemp1035 - (iTemp1036) as F64) * (fTemp1038 - (fTemp1039 + fTemp669 * (fTemp1040 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1037, 4), 196607))) as usize] } - fTemp1038))))} else {1.0 - (fTemp1033 + fTemp669 * fTemp1034 + (fTemp1029 - (iTemp1030) as F64) * (fTemp1032 - (fTemp1033 + fTemp669 * (fTemp1034 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1031, 4)) as usize] } - fTemp1032)))))} - fTemp1027) / (1.0 - fTemp1027))) as i32;
			...
			let mut fTemp1049: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1048, 3)) as usize] };
			let mut fTemp1050: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1048 as usize] };
			let mut fTemp1051: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1048, 1)) as usize] } - fTemp1050;
			...
			let mut fTemp1055: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1054, 3)) as usize] };
			let mut fTemp1056: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1054 as usize] };
			let mut fTemp1057: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1054, 1)) as usize] } - fTemp1056;
			let mut fTemp1058: F64 = if iTemp660 != 0 {fTemp1056 + fTemp669 * fTemp1057 + (fTemp1052 - (iTemp1053) as F64) * (fTemp1055 - (fTemp1056 + fTemp669 * (fTemp1057 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1054, 4)) as usize] } - fTemp1055))))} else {1.0 - (fTemp1050 + fTemp669 * fTemp1051 + (fTemp1046 - (iTemp1047) as F64) * (fTemp1049 - (fTemp1050 + fTemp669 * (fTemp1051 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1048, 4)) as usize] } - fTemp1049)))))};
			...
			let mut fTemp1063: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1062, 3)) as usize] };
			let mut fTemp1064: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1062 as usize] };
			let mut fTemp1065: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1062, 1)) as usize] } - fTemp1064;
			...
			let mut fTemp1069: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1068, 3), 196607))) as usize] };
			let mut fTemp1070: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1068 as usize] };
			let mut fTemp1071: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1068, 1), 196607))) as usize] } - fTemp1070;
			let mut iTemp1072: i32 = (fTemp730 > ((if iTemp660 != 0 {fTemp1070 + fTemp669 * fTemp1071 + (fTemp1066 - (iTemp1067) as F64) * (fTemp1069 - (fTemp1070 + fTemp669 * (fTemp1071 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1068, 4), 196607))) as usize] } - fTemp1069))))} else {1.0 - (fTemp1064 + fTemp669 * fTemp1065 + (fTemp1060 - (iTemp1061) as F64) * (fTemp1063 - (fTemp1064 + fTemp669 * (fTemp1065 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1062, 4)) as usize] } - fTemp1063)))))} - fTemp1058) / (1.0 - fTemp1058))) as i32;
			...
			let mut fTemp1080: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1079, 3)) as usize] };
			let mut fTemp1081: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1079 as usize] };
			let mut fTemp1082: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1079, 1)) as usize] } - fTemp1081;
			...
			let mut fTemp1086: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1085, 3)) as usize] };
			let mut fTemp1087: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1085 as usize] };
			let mut fTemp1088: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1085, 1)) as usize] } - fTemp1087;
			let mut fTemp1089: F64 = if iTemp660 != 0 {fTemp1087 + fTemp669 * fTemp1088 + (fTemp1083 - (iTemp1084) as F64) * (fTemp1086 - (fTemp1087 + fTemp669 * (fTemp1088 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1085, 4)) as usize] } - fTemp1086))))} else {1.0 - (fTemp1081 + fTemp669 * fTemp1082 + (fTemp1077 - (iTemp1078) as F64) * (fTemp1080 - (fTemp1081 + fTemp669 * (fTemp1082 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1079, 4)) as usize] } - fTemp1080)))))};
			...
			let mut fTemp1094: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1093, 3)) as usize] };
			let mut fTemp1095: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1093 as usize] };
			let mut fTemp1096: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1093, 1)) as usize] } - fTemp1095;
			...
			let mut fTemp1100: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1099, 3), 196607))) as usize] };
			let mut fTemp1101: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1099 as usize] };
			let mut fTemp1102: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1099, 1), 196607))) as usize] } - fTemp1101;
			let mut iTemp1103: i32 = (fTemp730 > ((if iTemp660 != 0 {fTemp1101 + fTemp669 * fTemp1102 + (fTemp1097 - (iTemp1098) as F64) * (fTemp1100 - (fTemp1101 + fTemp669 * (fTemp1102 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1099, 4), 196607))) as usize] } - fTemp1100))))} else {1.0 - (fTemp1095 + fTemp669 * fTemp1096 + (fTemp1091 - (iTemp1092) as F64) * (fTemp1094 - (fTemp1095 + fTemp669 * (fTemp1096 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1093, 4)) as usize] } - fTemp1094)))))} - fTemp1089) / (1.0 - fTemp1089))) as i32;
			...
			let mut fTemp1111: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1110, 3)) as usize] };
			let mut fTemp1112: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1110 as usize] };
			let mut fTemp1113: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1110, 1)) as usize] } - fTemp1112;
			...
			let mut fTemp1117: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1116, 3)) as usize] };
			let mut fTemp1118: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1116 as usize] };
			let mut fTemp1119: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1116, 1)) as usize] } - fTemp1118;
			let mut fTemp1120: F64 = if iTemp660 != 0 {fTemp1118 + fTemp669 * fTemp1119 + (fTemp1114 - (iTemp1115) as F64) * (fTemp1117 - (fTemp1118 + fTemp669 * (fTemp1119 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1116, 4)) as usize] } - fTemp1117))))} else {1.0 - (fTemp1112 + fTemp669 * fTemp1113 + (fTemp1108 - (iTemp1109) as F64) * (fTemp1111 - (fTemp1112 + fTemp669 * (fTemp1113 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1110, 4)) as usize] } - fTemp1111)))))};
			...
			let mut fTemp1125: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1124, 3)) as usize] };
			let mut fTemp1126: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1124 as usize] };
			let mut fTemp1127: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1124, 1)) as usize] } - fTemp1126;
			...
			let mut fTemp1131: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1130, 3), 196607))) as usize] };
			let mut fTemp1132: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1130 as usize] };
			let mut fTemp1133: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1130, 1), 196607))) as usize] } - fTemp1132;
			let mut iTemp1134: i32 = (fTemp730 > ((if iTemp660 != 0 {fTemp1132 + fTemp669 * fTemp1133 + (fTemp1128 - (iTemp1129) as F64) * (fTemp1131 - (fTemp1132 + fTemp669 * (fTemp1133 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1130, 4), 196607))) as usize] } - fTemp1131))))} else {1.0 - (fTemp1126 + fTemp669 * fTemp1127 + (fTemp1122 - (iTemp1123) as F64) * (fTemp1125 - (fTemp1126 + fTemp669 * (fTemp1127 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1124, 4)) as usize] } - fTemp1125)))))} - fTemp1120) / (1.0 - fTemp1120))) as i32;
			...
			let mut fTemp1142: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1141, 3)) as usize] };
			let mut fTemp1143: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1141 as usize] };
			let mut fTemp1144: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1141, 1)) as usize] } - fTemp1143;
			...
			let mut fTemp1148: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1147, 3)) as usize] };
			let mut fTemp1149: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1147 as usize] };
			let mut fTemp1150: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1147, 1)) as usize] } - fTemp1149;
			let mut fTemp1151: F64 = if iTemp660 != 0 {fTemp1149 + fTemp669 * fTemp1150 + (fTemp1145 - (iTemp1146) as F64) * (fTemp1148 - (fTemp1149 + fTemp669 * (fTemp1150 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1147, 4)) as usize] } - fTemp1148))))} else {1.0 - (fTemp1143 + fTemp669 * fTemp1144 + (fTemp1139 - (iTemp1140) as F64) * (fTemp1142 - (fTemp1143 + fTemp669 * (fTemp1144 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1141, 4)) as usize] } - fTemp1142)))))};
			...
			let mut fTemp1156: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1155, 3)) as usize] };
			let mut fTemp1157: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1155 as usize] };
			let mut fTemp1158: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1155, 1)) as usize] } - fTemp1157;
			...
			let mut fTemp1162: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1161, 3), 196607))) as usize] };
			let mut fTemp1163: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1161 as usize] };
			let mut fTemp1164: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1161, 1), 196607))) as usize] } - fTemp1163;
			let mut iTemp1165: i32 = (fTemp730 > ((if iTemp660 != 0 {fTemp1163 + fTemp669 * fTemp1164 + (fTemp1159 - (iTemp1160) as F64) * (fTemp1162 - (fTemp1163 + fTemp669 * (fTemp1164 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1161, 4), 196607))) as usize] } - fTemp1162))))} else {1.0 - (fTemp1157 + fTemp669 * fTemp1158 + (fTemp1153 - (iTemp1154) as F64) * (fTemp1156 - (fTemp1157 + fTemp669 * (fTemp1158 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1155, 4)) as usize] } - fTemp1156)))))} - fTemp1151) / (1.0 - fTemp1151))) as i32;
			...
			let mut fTemp1173: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1172, 3)) as usize] };
			let mut fTemp1174: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1172 as usize] };
			let mut fTemp1175: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1172, 1)) as usize] } - fTemp1174;
			...
			let mut fTemp1179: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1178, 3)) as usize] };
			let mut fTemp1180: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1178 as usize] };
			let mut fTemp1181: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1178, 1)) as usize] } - fTemp1180;
			let mut fTemp1182: F64 = if iTemp660 != 0 {fTemp1180 + fTemp669 * fTemp1181 + (fTemp1176 - (iTemp1177) as F64) * (fTemp1179 - (fTemp1180 + fTemp669 * (fTemp1181 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1178, 4), 196607))) as usize] } - fTemp1179))))} else {1.0 - (fTemp1174 + fTemp669 * fTemp1175 + (fTemp1170 - (iTemp1171) as F64) * (fTemp1173 - (fTemp1174 + fTemp669 * (fTemp1175 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1172, 4), 196607))) as usize] } - fTemp1173)))))};
			...
			let mut fTemp1187: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1186, 3)) as usize] };
			let mut fTemp1188: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1186 as usize] };
			let mut fTemp1189: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1186, 1)) as usize] } - fTemp1188;
			...
			let mut fTemp1193: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1192, 3), 196607))) as usize] };
			let mut fTemp1194: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1192 as usize] };
			let mut fTemp1195: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1192, 1), 196607))) as usize] } - fTemp1194;
			let mut iTemp1196: i32 = (fTemp730 > ((if iTemp660 != 0 {fTemp1194 + fTemp669 * fTemp1195 + (fTemp1190 - (iTemp1191) as F64) * (fTemp1193 - (fTemp1194 + fTemp669 * (fTemp1195 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1192, 4), 196607))) as usize] } - fTemp1193))))} else {1.0 - (fTemp1188 + fTemp669 * fTemp1189 + (fTemp1184 - (iTemp1185) as F64) * (fTemp1187 - (fTemp1188 + fTemp669 * (fTemp1189 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1186, 4)) as usize] } - fTemp1187)))))} - fTemp1182) / (1.0 - fTemp1182))) as i32;
			...
			let mut fTemp1201: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1200, 3)) as usize] };
			let mut fTemp1202: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1200 as usize] };
			let mut fTemp1203: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1200, 1)) as usize] } - fTemp1202;
			...
			let mut fTemp1207: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1206, 3)) as usize] };
			let mut fTemp1208: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1206 as usize] };
			let mut fTemp1209: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1206, 1)) as usize] } - fTemp1208;
			let mut fTemp1210: F64 = if iTemp660 != 0 {fTemp1208 + fTemp669 * fTemp1209 + (fTemp1204 - (iTemp1205) as F64) * (fTemp1207 - (fTemp1208 + fTemp669 * (fTemp1209 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1206, 4), 196607))) as usize] } - fTemp1207))))} else {1.0 - (fTemp1202 + fTemp669 * fTemp1203 + (fTemp1198 - (iTemp1199) as F64) * (fTemp1201 - (fTemp1202 + fTemp669 * (fTemp1203 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1200, 4), 196607))) as usize] } - fTemp1201)))))};
			...
			let mut fTemp1215: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1214, 3)) as usize] };
			let mut fTemp1216: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1214 as usize] };
			let mut fTemp1217: F64 = unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1214, 1)) as usize] } - fTemp1216;
			...
			let mut fTemp1221: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1220, 3), 196607))) as usize] };
			let mut fTemp1222: F64 = unsafe { ftbl0LambRs48kSIG0[iTemp1220 as usize] };
			let mut fTemp1223: F64 = unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1220, 1), 196607))) as usize] } - fTemp1222;
			let mut fTemp1224: F64 = fTemp634 + if ((0.001 * fTemp673) == 0.0) as i32 != 0 {fTemp659} else {fTemp659 * (if iTemp660 != 0 {fTemp1222 + fTemp669 * fTemp1223 + (fTemp1218 - (iTemp1219) as F64) * (fTemp1221 - (fTemp1222 + fTemp669 * (fTemp1223 - (unsafe { ftbl0LambRs48kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1220, 4), 196607))) as usize] } - fTemp1221))))} else {1.0 - (fTemp1216 + fTemp669 * fTemp1217 + (fTemp1212 - (iTemp1213) as F64) * (fTemp1215 - (fTemp1216 + fTemp669 * (fTemp1217 - (unsafe { ftbl0LambRs48kSIG0[(i32::wrapping_add(iTemp1214, 4)) as usize] } - fTemp1215)))))} - fTemp1210) / (1.0 - fTemp1210)};
			self.fRec16[(self.IOTA0 & 8191) as usize] = if iTemp672 != 0 {F64::min(fTemp1224, fTemp634)} else {F64::max(fTemp1224, fTemp634)};
			let mut fTemp1225: F64 = self.fRec16[((i32::wrapping_sub(self.IOTA0, iSlow71)) & 8191) as usize];
			*output1 = 0.5 * fTemp2 * self.fVec3[((i32::wrapping_sub(self.IOTA0, iSlow18)) & 32767) as usize] + self.fRec14[0] * fTemp4 * self.fVec4[((i32::wrapping_sub(self.IOTA0, iSlow18)) & 32767) as usize] * fTemp1225;
