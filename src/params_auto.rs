...
// nr of params: 9
    ...
    attack: FloatParam,
    #[id = "attack shape"]
    attack shape: FloatParam,
    #[id = "release"]
    release: FloatParam,
    #[id = "release shape"]
    release shape: FloatParam,
    #[id = "knee"]
    knee: FloatParam,
    #[id = "link"]
    link: FloatParam
...
impl Default for LambParams {
    fn default() -> Self {
        Self {
            input gain: FloatParam::new("input gain", 0.0, FloatRange::Linear { min: -24.0, max: 24.0}),
            ...
            attack shape: FloatParam::new("attack shape", 2.0, FloatRange::Linear { min: -4.0, max: 4.0}),
            release: FloatParam::new("release", 42.0, FloatRange::Linear { min: 1.0, max: 1000.0}),
            release shape: FloatParam::new("release shape", -3.0, FloatRange::Linear { min: -4.0, max: 4.0}),
...
pub const INPUT GAIN_PI: ParamIndex = ParamIndex(0);
...
pub const ATTACK SHAPE_PI: ParamIndex = ParamIndex(4);
pub const RELEASE_PI: ParamIndex = ParamIndex(5);
pub const RELEASE SHAPE_PI: ParamIndex = ParamIndex(6);
