...
Compilation options: -a /run/user/1001/.tmpzxIPi2 -lang rust -ct 1 -cn LambRs192k -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */
mod dsp_192k {
    #![allow(clippy::all)]
    #![allow(unused_parens)]
...
impl LambRs192kSIG0 {
	...
	fn fillLambRs192kSIG0(&mut self, count: i32, table: &mut[F64]) {
		for i1 in 0..count {
			...
			let mut fTemp72: F64 = (0.14285714285714285 * (iTemp68 % 3670016) as F64) as i32 as F64;
			table[i1 as usize] = F64::min(1.0, F64::max(0.0, if (fTemp70 == 0.0) as i32 != 0 {0.5 * (F64::sin(5.992123881747579e-06 * fTemp72 + 4.71238898038469) + 1.0)} else {0.5 * (F64::sin(3.141592653589793 * ((1.0 - F64::exp(-(4.615792495331755e-06 * fTemp71 * fTemp72))) / (1.0 - F64::exp(-(2.42 * fTemp71)))) + 4.71238898038469) + 1.0)}));
...
impl FaustDsp for LambRs192k {
	...
	fn metadata(&self, m: &mut dyn Meta) { 
		...
		m.declare("compile_options", r"-a /run/user/1001/.tmpzxIPi2 -lang rust -ct 1 -cn LambRs192k -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
	...
	fn compute(&mut self, count: i32, inputs: &[&[Self::T]], outputs: &mut[&mut[Self::T]]) {
		...
		for (((((input0, input1), output0), output1), output2), output3) in zipped_iterators {
			...
			let mut fTemp26: F64 = (self.iVec0[((i32::wrapping_sub(self.IOTA0, 19200)) & 32767) as usize]) as F64;
			...
			let mut fTemp41: F64 = F64::min(fTemp34, -(fSlow18 * F64::max(0.0, if (iTemp39 == 0) as i32 != 0 {0.0} else {if (iTemp39 == 1) as i32 != 0 {fSlow12 * LambRs192k_faustpower2_f(fSlow7 + fTemp40)} else {fTemp40}})));
			...
			let mut fTemp66: F64 = F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(if iSlow4 != 0 {self.fRec3[0]} else {1.7976931348623157e+308}, if iSlow49 != 0 {self.fVec19[iSlow4 as usize]} else {1.7976931348623157e+308}), if iSlow50 != 0 {self.fVec20[iSlow51 as usize]} else {1.7976931348623157e+308}), if iSlow52 != 0 {self.fVec21[iSlow53 as usize]} else {1.7976931348623157e+308}), if iSlow54 != 0 {self.fVec22[((i32::wrapping_sub(self.IOTA0, iSlow55)) & 31) as usize]} else {1.7976931348623157e+308}), if iSlow56 != 0 {self.fVec23[((i32::wrapping_sub(self.IOTA0, iSlow57)) & 63) as usize]} else {1.7976931348623157e+308}), if iSlow58 != 0 {self.fVec24[((i32::wrapping_sub(self.IOTA0, iSlow59)) & 127) as usize]} else {1.7976931348623157e+308}), if iSlow60 != 0 {self.fVec25[((i32::wrapping_sub(self.IOTA0, iSlow61)) & 255) as usize]} else {1.7976931348623157e+308}), if iSlow62 != 0 {self.fVec26[((i32::wrapping_sub(self.IOTA0, iSlow63)) & 511) as usize]} else {1.7976931348623157e+308}), if iSlow64 != 0 {self.fVec27[((i32::wrapping_sub(self.IOTA0, iSlow65)) & 1023) as usize]} else {1.7976931348623157e+308}), if iSlow66 != 0 {self.fVec28[((i32::wrapping_sub(self.IOTA0, iSlow67)) & 2047) as usize]} else {1.7976931348623157e+308}), if iSlow68 != 0 {self.fVec29[((i32::wrapping_sub(self.IOTA0, iSlow69)) & 4095) as usize]} else {1.7976931348623157e+308}), if iSlow70 != 0 {self.fVec30[((i32::wrapping_sub(self.IOTA0, iSlow71)) & 8191) as usize]} else {1.7976931348623157e+308}), if iSlow72 != 0 {self.fVec31[((i32::wrapping_sub(self.IOTA0, iSlow73)) & 16383) as usize]} else {1.7976931348623157e+308}) - self.fRec2[1];
			...
			let mut iTemp77: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, 1835001), 3670015));
			let mut fTemp78: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp77, 7)) as usize] };
			...
			let mut fTemp82: F64 = fTemp79 + fTemp81 * fTemp80 + 0.5 * (fTemp78 - (fTemp79 + fTemp81 * (fTemp80 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp77, 8)) as usize] } - fTemp78))));
			...
			let mut iTemp90: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp89, 524287)))), 3670015));
			let mut fTemp91: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp90, 7)) as usize] };
			...
			let mut iTemp96: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp95, 524287)))), 3670015));
			let mut fTemp97: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp96, 7), 3670015))) as usize] };
			let mut fTemp98: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp96 as usize] };
			let mut fTemp99: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp96, 1), 3670015))) as usize] } - fTemp98;
			...
			let mut iTemp105: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp104, 524287))), iTemp102), 3670015));
			let mut fTemp106: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp105, 7), 3670015))) as usize] };
			let mut fTemp107: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp105 as usize] };
			let mut fTemp108: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp105, 1), 3670015))) as usize] } - fTemp107;
			...
			let mut iTemp112: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp102, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp111, 524287)))), 3670015));
			let mut fTemp113: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp112, 7), 3670015))) as usize] };
			let mut fTemp114: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp112 as usize] };
			let mut fTemp115: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp112, 1), 3670015))) as usize] } - fTemp114;
			let mut fTemp116: F64 = self.fRec1[1] + fTemp86;
			let mut fTemp117: F64 = 524287.0 * (1.0 - fTemp116);
			let mut iTemp118: i32 = (fTemp117) as i32;
			let mut iTemp119: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp118, 524287)))), 3670015));
			let mut fTemp120: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp119, 7)) as usize] };
			...
			let mut iTemp125: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp124, 524287)))), 3670015));
			let mut fTemp126: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp125, 7), 3670015))) as usize] };
			let mut fTemp127: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp125 as usize] };
			let mut fTemp128: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp125, 1), 3670015))) as usize] } - fTemp127;
			...
			let mut iTemp132: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp131, 524287))), iTemp76), 3670015));
			let mut fTemp133: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp132, 7)) as usize] };
			...
			let mut iTemp138: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp137, 524287)))), 3670015));
			let mut fTemp139: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp138, 7), 3670015))) as usize] };
			let mut fTemp140: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp138 as usize] };
			let mut fTemp141: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp138, 1), 3670015))) as usize] } - fTemp140;
			let mut fTemp142: F64 = (if iTemp67 != 0 {fTemp140 + fTemp81 * fTemp141 + (fTemp136 - (iTemp137) as F64) * (fTemp139 - (fTemp140 + fTemp81 * (fTemp141 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp138, 8), 3670015))) as usize] } - fTemp139))))} else {1.0 - (fTemp134 + fTemp81 * fTemp135 + (fTemp130 - (iTemp131) as F64) * (fTemp133 - (fTemp134 + fTemp81 * (fTemp135 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp132, 8)) as usize] } - fTemp133)))))} - if iTemp67 != 0 {fTemp127 + fTemp81 * fTemp128 + (fTemp123 - (iTemp124) as F64) * (fTemp126 - (fTemp127 + fTemp81 * (fTemp128 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp125, 8), 3670015))) as usize] } - fTemp126))))} else {1.0 - (fTemp121 + fTemp81 * fTemp122 + (fTemp117 - (iTemp118) as F64) * (fTemp120 - (fTemp121 + fTemp81 * (fTemp122 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp119, 8)) as usize] } - fTemp120)))))}) * self.fVec32[1] / (fTemp66 * (1.0 - if iTemp67 != 0 {fTemp114 + fTemp109 * fTemp115 + (fTemp110 - (iTemp111) as F64) * (fTemp113 - (fTemp114 + fTemp109 * (fTemp115 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp112, 8), 3670015))) as usize] } - fTemp113))))} else {1.0 - (fTemp107 + fTemp109 * fTemp108 + (fTemp103 - (iTemp104) as F64) * (fTemp106 - (fTemp107 + fTemp109 * (fTemp108 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp105, 8), 3670015))) as usize] } - fTemp106)))))}));
			let mut iTemp143: i32 = (fTemp142 > ((if iTemp67 != 0 {fTemp98 + fTemp81 * fTemp99 + (fTemp94 - (iTemp95) as F64) * (fTemp97 - (fTemp98 + fTemp81 * (fTemp99 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp96, 8), 3670015))) as usize] } - fTemp97))))} else {1.0 - (fTemp92 + fTemp81 * fTemp93 + (fTemp88 - (iTemp89) as F64) * (fTemp91 - (fTemp92 + fTemp81 * (fTemp93 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp90, 8)) as usize] } - fTemp91)))))} - fTemp83) / (1.0 - fTemp83))) as i32;
			...
			let mut iTemp150: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp149, 524287)))), 3670015));
			let mut fTemp151: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp150, 7)) as usize] };
			...
			let mut iTemp156: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp155, 524287)))), 3670015));
			let mut fTemp157: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp156, 7)) as usize] };
			...
			let mut iTemp170: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp169, 524287)))), 3670015));
			let mut fTemp171: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp170, 7), 3670015))) as usize] };
			let mut fTemp172: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp170 as usize] };
			let mut fTemp173: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp170, 1), 3670015))) as usize] } - fTemp172;
			...
			let mut iTemp181: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp180, 524287)))), 3670015));
			let mut fTemp182: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp181, 7)) as usize] };
			...
			let mut iTemp187: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp186, 524287)))), 3670015));
			let mut fTemp188: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp187, 7)) as usize] };
			...
			let mut iTemp201: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp200, 524287)))), 3670015));
			let mut fTemp202: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp201, 7), 3670015))) as usize] };
			let mut fTemp203: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp201 as usize] };
			let mut fTemp204: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp201, 1), 3670015))) as usize] } - fTemp203;
			let mut iTemp205: i32 = (fTemp142 > ((if iTemp67 != 0 {fTemp203 + fTemp81 * fTemp204 + (fTemp199 - (iTemp200) as F64) * (fTemp202 - (fTemp203 + fTemp81 * (fTemp204 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp201, 8), 3670015))) as usize] } - fTemp202))))} else {1.0 - (fTemp197 + fTemp81 * fTemp198 + (fTemp193 - (iTemp194) as F64) * (fTemp196 - (fTemp197 + fTemp81 * (fTemp198 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp195, 8)) as usize] } - fTemp196)))))} - fTemp191) / (1.0 - fTemp191))) as i32;
			...
			let mut iTemp212: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp211, 524287)))), 3670015));
			let mut fTemp213: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp212, 7)) as usize] };
			...
			let mut iTemp218: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp217, 524287)))), 3670015));
			let mut fTemp219: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp218, 7)) as usize] };
			...
			let mut iTemp226: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp225, 524287)))), 3670015));
			let mut fTemp227: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp226, 7)) as usize] };
			...
			let mut iTemp232: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp231, 524287)))), 3670015));
			let mut fTemp233: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp232, 7), 3670015))) as usize] };
			let mut fTemp234: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp232 as usize] };
			let mut fTemp235: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp232, 1), 3670015))) as usize] } - fTemp234;
			let mut iTemp236: i32 = (fTemp142 > ((if iTemp67 != 0 {fTemp234 + fTemp81 * fTemp235 + (fTemp230 - (iTemp231) as F64) * (fTemp233 - (fTemp234 + fTemp81 * (fTemp235 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp232, 8), 3670015))) as usize] } - fTemp233))))} else {1.0 - (fTemp228 + fTemp81 * fTemp229 + (fTemp224 - (iTemp225) as F64) * (fTemp227 - (fTemp228 + fTemp81 * (fTemp229 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp226, 8)) as usize] } - fTemp227)))))} - fTemp222) / (1.0 - fTemp222))) as i32;
			...
			let mut iTemp243: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp242, 524287)))), 3670015));
			let mut fTemp244: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp243, 7)) as usize] };
			...
			let mut iTemp249: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp248, 524287)))), 3670015));
			let mut fTemp250: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp249, 7)) as usize] };
			...
			let mut iTemp263: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp262, 524287)))), 3670015));
			let mut fTemp264: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp263, 7), 3670015))) as usize] };
			let mut fTemp265: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp263 as usize] };
			let mut fTemp266: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp263, 1), 3670015))) as usize] } - fTemp265;
			let mut iTemp267: i32 = (fTemp142 > ((if iTemp67 != 0 {fTemp265 + fTemp81 * fTemp266 + (fTemp261 - (iTemp262) as F64) * (fTemp264 - (fTemp265 + fTemp81 * (fTemp266 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp263, 8), 3670015))) as usize] } - fTemp264))))} else {1.0 - (fTemp259 + fTemp81 * fTemp260 + (fTemp255 - (iTemp256) as F64) * (fTemp258 - (fTemp259 + fTemp81 * (fTemp260 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp257, 8)) as usize] } - fTemp258)))))} - fTemp253) / (1.0 - fTemp253))) as i32;
			...
			let mut iTemp274: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp273, 524287)))), 3670015));
			let mut fTemp275: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp274, 7)) as usize] };
			...
			let mut iTemp280: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp279, 524287)))), 3670015));
			let mut fTemp281: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp280, 7)) as usize] };
			...
			let mut iTemp288: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp287, 524287)))), 3670015));
			let mut fTemp289: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp288, 7)) as usize] };
			...
			let mut iTemp294: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp293, 524287)))), 3670015));
			let mut fTemp295: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp294, 7), 3670015))) as usize] };
			let mut fTemp296: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp294 as usize] };
			let mut fTemp297: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp294, 1), 3670015))) as usize] } - fTemp296;
			let mut iTemp298: i32 = (fTemp142 > ((if iTemp67 != 0 {fTemp296 + fTemp81 * fTemp297 + (fTemp292 - (iTemp293) as F64) * (fTemp295 - (fTemp296 + fTemp81 * (fTemp297 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp294, 8), 3670015))) as usize] } - fTemp295))))} else {1.0 - (fTemp290 + fTemp81 * fTemp291 + (fTemp286 - (iTemp287) as F64) * (fTemp289 - (fTemp290 + fTemp81 * (fTemp291 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp288, 8)) as usize] } - fTemp289)))))} - fTemp284) / (1.0 - fTemp284))) as i32;
			...
			let mut iTemp305: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp304, 524287)))), 3670015));
			let mut fTemp306: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp305, 7)) as usize] };
			...
			let mut iTemp311: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp310, 524287)))), 3670015));
			let mut fTemp312: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp311, 7)) as usize] };
			...
			let mut iTemp325: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp324, 524287)))), 3670015));
			let mut fTemp326: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp325, 7), 3670015))) as usize] };
			let mut fTemp327: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp325 as usize] };
			let mut fTemp328: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp325, 1), 3670015))) as usize] } - fTemp327;
			let mut iTemp329: i32 = (fTemp142 > ((if iTemp67 != 0 {fTemp327 + fTemp81 * fTemp328 + (fTemp323 - (iTemp324) as F64) * (fTemp326 - (fTemp327 + fTemp81 * (fTemp328 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp325, 8), 3670015))) as usize] } - fTemp326))))} else {1.0 - (fTemp321 + fTemp81 * fTemp322 + (fTemp317 - (iTemp318) as F64) * (fTemp320 - (fTemp321 + fTemp81 * (fTemp322 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp319, 8)) as usize] } - fTemp320)))))} - fTemp315) / (1.0 - fTemp315))) as i32;
			...
			let mut iTemp336: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp335, 524287)))), 3670015));
			let mut fTemp337: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp336, 7)) as usize] };
			...
			let mut iTemp342: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp341, 524287)))), 3670015));
			let mut fTemp343: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp342, 7)) as usize] };
			...
			let mut iTemp356: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp355, 524287)))), 3670015));
			let mut fTemp357: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp356, 7), 3670015))) as usize] };
			let mut fTemp358: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp356 as usize] };
			let mut fTemp359: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp356, 1), 3670015))) as usize] } - fTemp358;
			let mut iTemp360: i32 = (fTemp142 > ((if iTemp67 != 0 {fTemp358 + fTemp81 * fTemp359 + (fTemp354 - (iTemp355) as F64) * (fTemp357 - (fTemp358 + fTemp81 * (fTemp359 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp356, 8), 3670015))) as usize] } - fTemp357))))} else {1.0 - (fTemp352 + fTemp81 * fTemp353 + (fTemp348 - (iTemp349) as F64) * (fTemp351 - (fTemp352 + fTemp81 * (fTemp353 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp350, 8)) as usize] } - fTemp351)))))} - fTemp346) / (1.0 - fTemp346))) as i32;
			...
			let mut iTemp367: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp366, 524287)))), 3670015));
			let mut fTemp368: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp367, 7)) as usize] };
			...
			let mut iTemp373: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp372, 524287)))), 3670015));
			let mut fTemp374: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp373, 7)) as usize] };
			...
			let mut iTemp387: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp386, 524287)))), 3670015));
			let mut fTemp388: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp387, 7), 3670015))) as usize] };
			let mut fTemp389: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp387 as usize] };
			let mut fTemp390: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp387, 1), 3670015))) as usize] } - fTemp389;
			let mut iTemp391: i32 = (fTemp142 > ((if iTemp67 != 0 {fTemp389 + fTemp81 * fTemp390 + (fTemp385 - (iTemp386) as F64) * (fTemp388 - (fTemp389 + fTemp81 * (fTemp390 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp387, 8), 3670015))) as usize] } - fTemp388))))} else {1.0 - (fTemp383 + fTemp81 * fTemp384 + (fTemp379 - (iTemp380) as F64) * (fTemp382 - (fTemp383 + fTemp81 * (fTemp384 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp381, 8)) as usize] } - fTemp382)))))} - fTemp377) / (1.0 - fTemp377))) as i32;
			...
			let mut iTemp398: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp397, 524287)))), 3670015));
			let mut fTemp399: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp398, 7)) as usize] };
			...
			let mut iTemp404: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp403, 524287)))), 3670015));
			let mut fTemp405: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp404, 7)) as usize] };
			...
			let mut iTemp429: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp428, 524287)))), 3670015));
			let mut fTemp430: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp429, 7)) as usize] };
			...
			let mut iTemp435: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp434, 524287)))), 3670015));
			let mut fTemp436: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp435, 7)) as usize] };
			...
			let mut iTemp449: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp448, 524287)))), 3670015));
			let mut fTemp450: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp449, 7), 3670015))) as usize] };
			let mut fTemp451: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp449 as usize] };
			let mut fTemp452: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp449, 1), 3670015))) as usize] } - fTemp451;
			let mut iTemp453: i32 = (fTemp142 > ((if iTemp67 != 0 {fTemp451 + fTemp81 * fTemp452 + (fTemp447 - (iTemp448) as F64) * (fTemp450 - (fTemp451 + fTemp81 * (fTemp452 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp449, 8), 3670015))) as usize] } - fTemp450))))} else {1.0 - (fTemp445 + fTemp81 * fTemp446 + (fTemp441 - (iTemp442) as F64) * (fTemp444 - (fTemp445 + fTemp81 * (fTemp446 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp443, 8)) as usize] } - fTemp444)))))} - fTemp439) / (1.0 - fTemp439))) as i32;
			...
			let mut iTemp460: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp459, 524287)))), 3670015));
			let mut fTemp461: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp460, 7)) as usize] };
			...
			let mut iTemp466: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp465, 524287)))), 3670015));
			let mut fTemp467: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp466, 7)) as usize] };
			...
			let mut iTemp480: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp479, 524287)))), 3670015));
			let mut fTemp481: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp480, 7), 3670015))) as usize] };
			let mut fTemp482: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp480 as usize] };
			let mut fTemp483: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp480, 1), 3670015))) as usize] } - fTemp482;
			let mut iTemp484: i32 = (fTemp142 > ((if iTemp67 != 0 {fTemp482 + fTemp81 * fTemp483 + (fTemp478 - (iTemp479) as F64) * (fTemp481 - (fTemp482 + fTemp81 * (fTemp483 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp480, 8), 3670015))) as usize] } - fTemp481))))} else {1.0 - (fTemp476 + fTemp81 * fTemp477 + (fTemp472 - (iTemp473) as F64) * (fTemp475 - (fTemp476 + fTemp81 * (fTemp477 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp474, 8)) as usize] } - fTemp475)))))} - fTemp470) / (1.0 - fTemp470))) as i32;
			...
			let mut iTemp491: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp490, 524287)))), 3670015));
			let mut fTemp492: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp491, 7)) as usize] };
			...
			let mut iTemp497: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp496, 524287)))), 3670015));
			let mut fTemp498: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp497, 7)) as usize] };
			...
			let mut iTemp511: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp510, 524287)))), 3670015));
			let mut fTemp512: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp511, 7), 3670015))) as usize] };
			let mut fTemp513: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp511 as usize] };
			let mut fTemp514: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp511, 1), 3670015))) as usize] } - fTemp513;
			...
			let mut iTemp522: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp521, 524287)))), 3670015));
			let mut fTemp523: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp522, 7)) as usize] };
			...
			let mut iTemp528: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp527, 524287)))), 3670015));
			let mut fTemp529: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp528, 7)) as usize] };
			...
			let mut iTemp542: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp541, 524287)))), 3670015));
			let mut fTemp543: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp542, 7), 3670015))) as usize] };
			let mut fTemp544: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp542 as usize] };
			let mut fTemp545: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp542, 1), 3670015))) as usize] } - fTemp544;
			let mut iTemp546: i32 = (fTemp142 > ((if iTemp67 != 0 {fTemp544 + fTemp81 * fTemp545 + (fTemp540 - (iTemp541) as F64) * (fTemp543 - (fTemp544 + fTemp81 * (fTemp545 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp542, 8), 3670015))) as usize] } - fTemp543))))} else {1.0 - (fTemp538 + fTemp81 * fTemp539 + (fTemp534 - (iTemp535) as F64) * (fTemp537 - (fTemp538 + fTemp81 * (fTemp539 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp536, 8)) as usize] } - fTemp537)))))} - fTemp532) / (1.0 - fTemp532))) as i32;
			...
			let mut iTemp553: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp552, 524287)))), 3670015));
			let mut fTemp554: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp553, 7)) as usize] };
			...
			let mut iTemp559: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp558, 524287)))), 3670015));
			let mut fTemp560: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp559, 7)) as usize] };
			...
			let mut iTemp573: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp572, 524287)))), 3670015));
			let mut fTemp574: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp573, 7), 3670015))) as usize] };
			let mut fTemp575: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp573 as usize] };
			let mut fTemp576: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp573, 1), 3670015))) as usize] } - fTemp575;
			...
			let mut iTemp584: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp583, 524287)))), 3670015));
			let mut fTemp585: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp584, 7)) as usize] };
			...
			let mut iTemp590: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp589, 524287)))), 3670015));
			let mut fTemp591: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp590, 7)) as usize] };
			...
			let mut iTemp604: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp603, 524287)))), 3670015));
			let mut fTemp605: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp604, 7), 3670015))) as usize] };
			let mut fTemp606: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp604 as usize] };
			let mut fTemp607: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp604, 1), 3670015))) as usize] } - fTemp606;
			let mut iTemp608: i32 = (fTemp142 > ((if iTemp67 != 0 {fTemp606 + fTemp81 * fTemp607 + (fTemp602 - (iTemp603) as F64) * (fTemp605 - (fTemp606 + fTemp81 * (fTemp607 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp604, 8), 3670015))) as usize] } - fTemp605))))} else {1.0 - (fTemp600 + fTemp81 * fTemp601 + (fTemp596 - (iTemp597) as F64) * (fTemp599 - (fTemp600 + fTemp81 * (fTemp601 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp598, 8)) as usize] } - fTemp599)))))} - fTemp594) / (1.0 - fTemp594))) as i32;
			...
			let mut iTemp615: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp614, 524287)))), 3670015));
			let mut fTemp616: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp615, 7)) as usize] };
			...
			let mut iTemp621: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp620, 524287)))), 3670015));
			let mut fTemp622: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp621, 7)) as usize] };
			...
			let mut iTemp635: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp634, 524287)))), 3670015));
			let mut fTemp636: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp635, 7), 3670015))) as usize] };
			let mut fTemp637: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp635 as usize] };
			let mut fTemp638: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp635, 1), 3670015))) as usize] } - fTemp637;
			let mut iTemp639: i32 = (fTemp142 > ((if iTemp67 != 0 {fTemp637 + fTemp81 * fTemp638 + (fTemp633 - (iTemp634) as F64) * (fTemp636 - (fTemp637 + fTemp81 * (fTemp638 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp635, 8), 3670015))) as usize] } - fTemp636))))} else {1.0 - (fTemp631 + fTemp81 * fTemp632 + (fTemp627 - (iTemp628) as F64) * (fTemp630 - (fTemp631 + fTemp81 * (fTemp632 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp629, 8)) as usize] } - fTemp630)))))} - fTemp625) / (1.0 - fTemp625))) as i32;
			...
			let mut iTemp646: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp645, 524287)))), 3670015));
			let mut fTemp647: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp646, 7)) as usize] };
			...
			let mut iTemp652: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp651, 524287)))), 3670015));
			let mut fTemp653: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp652, 7)) as usize] };
			...
			let mut iTemp660: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp659, 524287)))), 3670015));
			let mut fTemp661: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp660, 7)) as usize] };
			...
			let mut iTemp666: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp665, 524287)))), 3670015));
			let mut fTemp667: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp666, 7), 3670015))) as usize] };
			let mut fTemp668: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp666 as usize] };
			let mut fTemp669: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp666, 1), 3670015))) as usize] } - fTemp668;
			...
			let mut iTemp677: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp676, 524287)))), 3670015));
			let mut fTemp678: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp677, 7)) as usize] };
			...
			let mut iTemp683: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp682, 524287)))), 3670015));
			let mut fTemp684: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp683, 7)) as usize] };
			...
			let mut fTemp687: F64 = if iTemp67 != 0 {fTemp685 + fTemp81 * fTemp686 + (fTemp681 - (iTemp682) as F64) * (fTemp684 - (fTemp685 + fTemp81 * (fTemp686 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp683, 8), 3670015))) as usize] } - fTemp684))))} else {1.0 - (fTemp679 + fTemp81 * fTemp680 + (fTemp675 - (iTemp676) as F64) * (fTemp678 - (fTemp679 + fTemp81 * (fTemp680 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp677, 8), 3670015))) as usize] } - fTemp678)))))};
			let mut fTemp688: F64 = fTemp86 + fTemp674;
			let mut fTemp689: F64 = 524287.0 * (1.0 - fTemp688);
			let mut iTemp690: i32 = (fTemp689) as i32;
			let mut iTemp691: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp690, 524287)))), 3670015));
			let mut fTemp692: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp691, 7)) as usize] };
			...
			let mut iTemp697: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp696, 524287)))), 3670015));
			let mut fTemp698: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp697, 7), 3670015))) as usize] };
			let mut fTemp699: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp697 as usize] };
			let mut fTemp700: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp697, 1), 3670015))) as usize] } - fTemp699;
			let mut iTemp701: i32 = (fTemp142 > ((if iTemp67 != 0 {fTemp699 + fTemp81 * fTemp700 + (fTemp695 - (iTemp696) as F64) * (fTemp698 - (fTemp699 + fTemp81 * (fTemp700 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp697, 8), 3670015))) as usize] } - fTemp698))))} else {1.0 - (fTemp693 + fTemp81 * fTemp694 + (fTemp689 - (iTemp690) as F64) * (fTemp692 - (fTemp693 + fTemp81 * (fTemp694 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp691, 8)) as usize] } - fTemp692)))))} - fTemp687) / (1.0 - fTemp687))) as i32;
			let mut fTemp702: F64 = F64::min(1.0, F64::max(0.0, 0.5 * (if iTemp701 != 0 {fTemp674} else {fTemp672} + if iTemp701 != 0 {fTemp671} else {fTemp674})));
			self.fRec1[0] = fTemp702;
			let mut fTemp703: F64 = 524287.0 * (1.0 - fTemp702);
			let mut iTemp704: i32 = (fTemp703) as i32;
			let mut iTemp705: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp704, 524287)))), 3670015));
			let mut fTemp706: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp705, 7)) as usize] };
			let mut fTemp707: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp705 as usize] };
			let mut fTemp708: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp705, 1)) as usize] } - fTemp707;
			let mut fTemp709: F64 = 524287.0 * fTemp702;
			let mut iTemp710: i32 = (fTemp709) as i32;
			let mut iTemp711: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp710, 524287)))), 3670015));
			let mut fTemp712: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp711, 7)) as usize] };
			let mut fTemp713: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp711 as usize] };
			let mut fTemp714: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp711, 1)) as usize] } - fTemp713;
			let mut fTemp715: F64 = if iTemp67 != 0 {fTemp713 + fTemp81 * fTemp714 + (fTemp709 - (iTemp710) as F64) * (fTemp712 - (fTemp713 + fTemp81 * (fTemp714 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp711, 8), 3670015))) as usize] } - fTemp712))))} else {1.0 - (fTemp707 + fTemp81 * fTemp708 + (fTemp703 - (iTemp704) as F64) * (fTemp706 - (fTemp707 + fTemp81 * (fTemp708 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp705, 8), 3670015))) as usize] } - fTemp706)))))};
			let mut fTemp716: F64 = fTemp86 + fTemp702;
			let mut fTemp717: F64 = 524287.0 * (1.0 - fTemp716);
			let mut iTemp718: i32 = (fTemp717) as i32;
			let mut iTemp719: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp718, 524287)))), 3670015));
			let mut fTemp720: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp719, 7)) as usize] };
			let mut fTemp721: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp719 as usize] };
			let mut fTemp722: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp719, 1)) as usize] } - fTemp721;
			let mut fTemp723: F64 = 524287.0 * fTemp716;
			let mut iTemp724: i32 = (fTemp723) as i32;
			let mut iTemp725: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp76, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp724, 524287)))), 3670015));
			let mut fTemp726: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp725, 7), 3670015))) as usize] };
			let mut fTemp727: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp725 as usize] };
			let mut fTemp728: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp725, 1), 3670015))) as usize] } - fTemp727;
			let mut fTemp729: F64 = self.fRec2[1] + if ((0.001 * fTemp85) == 0.0) as i32 != 0 {fTemp66} else {fTemp66 * (if iTemp67 != 0 {fTemp727 + fTemp81 * fTemp728 + (fTemp723 - (iTemp724) as F64) * (fTemp726 - (fTemp727 + fTemp81 * (fTemp728 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp725, 8), 3670015))) as usize] } - fTemp726))))} else {1.0 - (fTemp721 + fTemp81 * fTemp722 + (fTemp717 - (iTemp718) as F64) * (fTemp720 - (fTemp721 + fTemp81 * (fTemp722 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp719, 8)) as usize] } - fTemp720)))))} - fTemp715) / (1.0 - fTemp715)};
			self.fRec2[0] = if iTemp84 != 0 {F64::min(fTemp729, self.fRec2[1])} else {F64::max(fTemp729, self.fRec2[1])};
			self.fVec35[(self.IOTA0 & 32767) as usize] = F64::powf(1e+01, 0.05 * self.fRec2[0]);
			let mut fTemp730: F64 = self.fVec35[((i32::wrapping_sub(self.IOTA0, iSlow78)) & 32767) as usize];
			self.fRec14[0] = fSlow80 + self.fConst4 * self.fRec14[1];
			*output0 = 0.5 * self.fVec1[((i32::wrapping_sub(self.IOTA0, iSlow79)) & 32767) as usize] * fTemp2 + self.fRec14[0] * self.fVec2[((i32::wrapping_sub(self.IOTA0, iSlow79)) & 32767) as usize] * fTemp730 * fTemp4;
			let mut fTemp731: F64 = fTemp36 + fSlow17 * (fTemp37 - fTemp36);
			let mut iTemp732: i32 = ((fTemp731 > fSlow11) as i32) + ((fTemp731 > fSlow9) as i32);
			let mut fTemp733: F64 = fTemp731 - fSlow8;
			let mut fTemp734: F64 = F64::min(fTemp34, -(fSlow18 * F64::max(0.0, if (iTemp732 == 0) as i32 != 0 {0.0} else {if (iTemp732 == 1) as i32 != 0 {fSlow12 * LambRs192k_faustpower2_f(fSlow7 + fTemp733)} else {fTemp733}})));
			self.fVec36[(self.IOTA0 & 16383) as usize] = fTemp734;
			let mut fTemp735: F64 = F64::min(fTemp734, self.fVec36[((i32::wrapping_sub(self.IOTA0, 1)) & 16383) as usize]);
			...
			let mut fTemp739: F64 = F64::min(fTemp738, self.fVec40[((i32::wrapping_sub(self.IOTA0, 16)) & 31) as usize]);
			self.fVec41[(self.IOTA0 & 63) as usize] = fTemp739;
			let mut fTemp740: F64 = F64::min(fTemp739, self.fVec41[((i32::wrapping_sub(self.IOTA0, 32)) & 63) as usize]);
			self.fVec42[(self.IOTA0 & 127) as usize] = fTemp740;
			let mut fTemp741: F64 = F64::min(fTemp740, self.fVec42[((i32::wrapping_sub(self.IOTA0, 64)) & 127) as usize]);
			self.fVec43[(self.IOTA0 & 255) as usize] = fTemp741;
			let mut fTemp742: F64 = F64::min(fTemp741, self.fVec43[((i32::wrapping_sub(self.IOTA0, 128)) & 255) as usize]);
			self.fVec44[(self.IOTA0 & 511) as usize] = fTemp742;
			let mut fTemp743: F64 = F64::min(fTemp742, self.fVec44[((i32::wrapping_sub(self.IOTA0, 256)) & 511) as usize]);
			self.fVec45[(self.IOTA0 & 1023) as usize] = fTemp743;
			let mut fTemp744: F64 = F64::min(fTemp743, self.fVec45[((i32::wrapping_sub(self.IOTA0, 512)) & 1023) as usize]);
			self.fVec46[(self.IOTA0 & 2047) as usize] = fTemp744;
			let mut fTemp745: F64 = F64::min(fTemp744, self.fVec46[((i32::wrapping_sub(self.IOTA0, 1024)) & 2047) as usize]);
			self.fVec47[(self.IOTA0 & 4095) as usize] = fTemp745;
			let mut fTemp746: F64 = F64::min(fTemp745, self.fVec47[((i32::wrapping_sub(self.IOTA0, 2048)) & 4095) as usize]);
			self.fVec48[(self.IOTA0 & 8191) as usize] = fTemp746;
			self.fVec49[(self.IOTA0 & 16383) as usize] = F64::min(fTemp746, self.fVec48[((i32::wrapping_sub(self.IOTA0, 4096)) & 8191) as usize]);
			self.fRec17[0] = F64::max(F64::min(self.fRec17[1], self.fVec36[((i32::wrapping_sub(self.IOTA0, iSlow21)) & 16383) as usize]), F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(if iSlow23 != 0 {fTemp734} else {1.7976931348623157e+308}, if iSlow24 != 0 {self.fVec37[iSlow23 as usize]} else {1.7976931348623157e+308}), if iSlow25 != 0 {self.fVec38[iSlow26 as usize]} else {1.7976931348623157e+308}), if iSlow27 != 0 {self.fVec39[iSlow28 as usize]} else {1.7976931348623157e+308}), if iSlow29 != 0 {self.fVec40[((i32::wrapping_sub(self.IOTA0, iSlow30)) & 31) as usize]} else {1.7976931348623157e+308}), if iSlow31 != 0 {self.fVec41[((i32::wrapping_sub(self.IOTA0, iSlow32)) & 63) as usize]} else {1.7976931348623157e+308}), if iSlow33 != 0 {self.fVec42[((i32::wrapping_sub(self.IOTA0, iSlow34)) & 127) as usize]} else {1.7976931348623157e+308}), if iSlow35 != 0 {self.fVec43[((i32::wrapping_sub(self.IOTA0, iSlow36)) & 255) as usize]} else {1.7976931348623157e+308}), if iSlow37 != 0 {self.fVec44[((i32::wrapping_sub(self.IOTA0, iSlow38)) & 511) as usize]} else {1.7976931348623157e+308}), if iSlow39 != 0 {self.fVec45[((i32::wrapping_sub(self.IOTA0, iSlow40)) & 1023) as usize]} else {1.7976931348623157e+308}), if iSlow41 != 0 {self.fVec46[((i32::wrapping_sub(self.IOTA0, iSlow42)) & 2047) as usize]} else {1.7976931348623157e+308}), if iSlow43 != 0 {self.fVec47[((i32::wrapping_sub(self.IOTA0, iSlow44)) & 4095) as usize]} else {1.7976931348623157e+308}), if iSlow45 != 0 {self.fVec48[((i32::wrapping_sub(self.IOTA0, iSlow46)) & 8191) as usize]} else {1.7976931348623157e+308}), if iSlow47 != 0 {self.fVec49[((i32::wrapping_sub(self.IOTA0, iSlow48)) & 16383) as usize]} else {1.7976931348623157e+308}));
			...
			let mut fTemp751: F64 = F64::min(fTemp750, self.fVec53[((i32::wrapping_sub(self.IOTA0, 16)) & 31) as usize]);
			self.fVec54[(self.IOTA0 & 63) as usize] = fTemp751;
			let mut fTemp752: F64 = F64::min(fTemp751, self.fVec54[((i32::wrapping_sub(self.IOTA0, 32)) & 63) as usize]);
			self.fVec55[(self.IOTA0 & 127) as usize] = fTemp752;
			let mut fTemp753: F64 = F64::min(fTemp752, self.fVec55[((i32::wrapping_sub(self.IOTA0, 64)) & 127) as usize]);
			self.fVec56[(self.IOTA0 & 255) as usize] = fTemp753;
			let mut fTemp754: F64 = F64::min(fTemp753, self.fVec56[((i32::wrapping_sub(self.IOTA0, 128)) & 255) as usize]);
			self.fVec57[(self.IOTA0 & 511) as usize] = fTemp754;
			let mut fTemp755: F64 = F64::min(fTemp754, self.fVec57[((i32::wrapping_sub(self.IOTA0, 256)) & 511) as usize]);
			self.fVec58[(self.IOTA0 & 1023) as usize] = fTemp755;
			let mut fTemp756: F64 = F64::min(fTemp755, self.fVec58[((i32::wrapping_sub(self.IOTA0, 512)) & 1023) as usize]);
			self.fVec59[(self.IOTA0 & 2047) as usize] = fTemp756;
			let mut fTemp757: F64 = F64::min(fTemp756, self.fVec59[((i32::wrapping_sub(self.IOTA0, 1024)) & 2047) as usize]);
			self.fVec60[(self.IOTA0 & 4095) as usize] = fTemp757;
			let mut fTemp758: F64 = F64::min(fTemp757, self.fVec60[((i32::wrapping_sub(self.IOTA0, 2048)) & 4095) as usize]);
			self.fVec61[(self.IOTA0 & 8191) as usize] = fTemp758;
			self.fVec62[(self.IOTA0 & 16383) as usize] = F64::min(fTemp758, self.fVec61[((i32::wrapping_sub(self.IOTA0, 4096)) & 8191) as usize]);
			let mut fTemp759: F64 = F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(F64::min(if iSlow4 != 0 {self.fRec17[0]} else {1.7976931348623157e+308}, if iSlow49 != 0 {self.fVec50[iSlow4 as usize]} else {1.7976931348623157e+308}), if iSlow50 != 0 {self.fVec51[iSlow51 as usize]} else {1.7976931348623157e+308}), if iSlow52 != 0 {self.fVec52[iSlow53 as usize]} else {1.7976931348623157e+308}), if iSlow54 != 0 {self.fVec53[((i32::wrapping_sub(self.IOTA0, iSlow55)) & 31) as usize]} else {1.7976931348623157e+308}), if iSlow56 != 0 {self.fVec54[((i32::wrapping_sub(self.IOTA0, iSlow57)) & 63) as usize]} else {1.7976931348623157e+308}), if iSlow58 != 0 {self.fVec55[((i32::wrapping_sub(self.IOTA0, iSlow59)) & 127) as usize]} else {1.7976931348623157e+308}), if iSlow60 != 0 {self.fVec56[((i32::wrapping_sub(self.IOTA0, iSlow61)) & 255) as usize]} else {1.7976931348623157e+308}), if iSlow62 != 0 {self.fVec57[((i32::wrapping_sub(self.IOTA0, iSlow63)) & 511) as usize]} else {1.7976931348623157e+308}), if iSlow64 != 0 {self.fVec58[((i32::wrapping_sub(self.IOTA0, iSlow65)) & 1023) as usize]} else {1.7976931348623157e+308}), if iSlow66 != 0 {self.fVec59[((i32::wrapping_sub(self.IOTA0, iSlow67)) & 2047) as usize]} else {1.7976931348623157e+308}), if iSlow68 != 0 {self.fVec60[((i32::wrapping_sub(self.IOTA0, iSlow69)) & 4095) as usize]} else {1.7976931348623157e+308}), if iSlow70 != 0 {self.fVec61[((i32::wrapping_sub(self.IOTA0, iSlow71)) & 8191) as usize]} else {1.7976931348623157e+308}), if iSlow72 != 0 {self.fVec62[((i32::wrapping_sub(self.IOTA0, iSlow73)) & 16383) as usize]} else {1.7976931348623157e+308}) - self.fRec16[1];
			...
			let mut iTemp765: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, 1835001), 3670015));
			let mut fTemp766: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp765, 7)) as usize] };
			let mut fTemp767: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp765 as usize] };
			let mut fTemp768: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp765, 1)) as usize] } - fTemp767;
			let mut fTemp769: F64 = fTemp762 - (iTemp763) as F64;
			let mut fTemp770: F64 = fTemp767 + fTemp769 * fTemp768 + 0.5 * (fTemp766 - (fTemp767 + fTemp769 * (fTemp768 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp765, 8)) as usize] } - fTemp766))));
			let mut fTemp771: F64 = if iTemp760 != 0 {fTemp770} else {1.0 - fTemp770};
			...
			let mut iTemp778: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp777, 524287)))), 3670015));
			let mut fTemp779: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp778, 7)) as usize] };
			let mut fTemp780: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp778 as usize] };
			let mut fTemp781: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp778, 1)) as usize] } - fTemp780;
			let mut fTemp782: F64 = 524287.0 * fTemp775;
			let mut iTemp783: i32 = (fTemp782) as i32;
			let mut iTemp784: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp783, 524287)))), 3670015));
			let mut fTemp785: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp784, 7), 3670015))) as usize] };
			let mut fTemp786: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp784 as usize] };
			let mut fTemp787: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp784, 1), 3670015))) as usize] } - fTemp786;
			...
			let mut iTemp793: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp792, 524287))), iTemp790), 3670015));
			let mut fTemp794: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp793, 7), 3670015))) as usize] };
			let mut fTemp795: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp793 as usize] };
			let mut fTemp796: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp793, 1), 3670015))) as usize] } - fTemp795;
			...
			let mut iTemp800: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp790, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp799, 524287)))), 3670015));
			let mut fTemp801: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp800, 7), 3670015))) as usize] };
			let mut fTemp802: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp800 as usize] };
			let mut fTemp803: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp800, 1), 3670015))) as usize] } - fTemp802;
			...
			let mut iTemp807: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp806, 524287)))), 3670015));
			let mut fTemp808: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp807, 7)) as usize] };
			...
			let mut iTemp813: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp812, 524287)))), 3670015));
			let mut fTemp814: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp813, 7), 3670015))) as usize] };
			let mut fTemp815: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp813 as usize] };
			let mut fTemp816: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp813, 1), 3670015))) as usize] } - fTemp815;
			let mut fTemp817: F64 = self.fRec15[1] + self.fConst10 * (1.0 / fTemp773 + 1.0 / self.fVec65[1]);
			let mut fTemp818: F64 = 524287.0 * (1.0 - fTemp817);
			let mut iTemp819: i32 = (fTemp818) as i32;
			let mut iTemp820: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp819, 524287))), iTemp764), 3670015));
			let mut fTemp821: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp820, 7)) as usize] };
			let mut fTemp822: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp820 as usize] };
			let mut fTemp823: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp820, 1)) as usize] } - fTemp822;
			let mut fTemp824: F64 = 524287.0 * fTemp817;
			let mut iTemp825: i32 = (fTemp824) as i32;
			let mut iTemp826: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp825, 524287)))), 3670015));
			let mut fTemp827: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp826, 7), 3670015))) as usize] };
			let mut fTemp828: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp826 as usize] };
			let mut fTemp829: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp826, 1), 3670015))) as usize] } - fTemp828;
			let mut fTemp830: F64 = (if iTemp760 != 0 {fTemp828 + fTemp769 * fTemp829 + (fTemp824 - (iTemp825) as F64) * (fTemp827 - (fTemp828 + fTemp769 * (fTemp829 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp826, 8), 3670015))) as usize] } - fTemp827))))} else {1.0 - (fTemp822 + fTemp769 * fTemp823 + (fTemp818 - (iTemp819) as F64) * (fTemp821 - (fTemp822 + fTemp769 * (fTemp823 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp820, 8)) as usize] } - fTemp821)))))} - if iTemp760 != 0 {fTemp815 + fTemp769 * fTemp816 + (fTemp811 - (iTemp812) as F64) * (fTemp814 - (fTemp815 + fTemp769 * (fTemp816 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp813, 8), 3670015))) as usize] } - fTemp814))))} else {1.0 - (fTemp809 + fTemp769 * fTemp810 + (fTemp805 - (iTemp806) as F64) * (fTemp808 - (fTemp809 + fTemp769 * (fTemp810 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp807, 8)) as usize] } - fTemp808)))))}) * self.fVec63[1] / (fTemp759 * (1.0 - if iTemp760 != 0 {fTemp802 + fTemp797 * fTemp803 + (fTemp798 - (iTemp799) as F64) * (fTemp801 - (fTemp802 + fTemp797 * (fTemp803 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp800, 8), 3670015))) as usize] } - fTemp801))))} else {1.0 - (fTemp795 + fTemp797 * fTemp796 + (fTemp791 - (iTemp792) as F64) * (fTemp794 - (fTemp795 + fTemp797 * (fTemp796 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp793, 8), 3670015))) as usize] } - fTemp794)))))}));
			let mut iTemp831: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp786 + fTemp769 * fTemp787 + (fTemp782 - (iTemp783) as F64) * (fTemp785 - (fTemp786 + fTemp769 * (fTemp787 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp784, 8), 3670015))) as usize] } - fTemp785))))} else {1.0 - (fTemp780 + fTemp769 * fTemp781 + (fTemp776 - (iTemp777) as F64) * (fTemp779 - (fTemp780 + fTemp769 * (fTemp781 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp778, 8)) as usize] } - fTemp779)))))} - fTemp771) / (1.0 - fTemp771))) as i32;
			...
			let mut iTemp838: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp837, 524287)))), 3670015));
			let mut fTemp839: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp838, 7)) as usize] };
			...
			let mut iTemp844: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp843, 524287)))), 3670015));
			let mut fTemp845: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp844, 7)) as usize] };
			...
			let mut iTemp858: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp857, 524287)))), 3670015));
			let mut fTemp859: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp858, 7), 3670015))) as usize] };
			let mut fTemp860: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp858 as usize] };
			let mut fTemp861: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp858, 1), 3670015))) as usize] } - fTemp860;
			let mut iTemp862: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp860 + fTemp769 * fTemp861 + (fTemp856 - (iTemp857) as F64) * (fTemp859 - (fTemp860 + fTemp769 * (fTemp861 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp858, 8), 3670015))) as usize] } - fTemp859))))} else {1.0 - (fTemp854 + fTemp769 * fTemp855 + (fTemp850 - (iTemp851) as F64) * (fTemp853 - (fTemp854 + fTemp769 * (fTemp855 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp852, 8)) as usize] } - fTemp853)))))} - fTemp848) / (1.0 - fTemp848))) as i32;
			...
			let mut iTemp869: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp868, 524287)))), 3670015));
			let mut fTemp870: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp869, 7)) as usize] };
			...
			let mut iTemp875: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp874, 524287)))), 3670015));
			let mut fTemp876: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp875, 7)) as usize] };
			...
			let mut fTemp879: F64 = if iTemp760 != 0 {fTemp877 + fTemp769 * fTemp878 + (fTemp873 - (iTemp874) as F64) * (fTemp876 - (fTemp877 + fTemp769 * (fTemp878 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp875, 8)) as usize] } - fTemp876))))} else {1.0 - (fTemp871 + fTemp769 * fTemp872 + (fTemp867 - (iTemp868) as F64) * (fTemp870 - (fTemp871 + fTemp769 * (fTemp872 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp869, 8)) as usize] } - fTemp870)))))};
			let mut fTemp880: F64 = fTemp774 + fTemp866;
			let mut fTemp881: F64 = 524287.0 * (1.0 - fTemp880);
			let mut iTemp882: i32 = (fTemp881) as i32;
			let mut iTemp883: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp882, 524287)))), 3670015));
			let mut fTemp884: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp883, 7)) as usize] };
			...
			let mut iTemp889: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp888, 524287)))), 3670015));
			let mut fTemp890: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp889, 7), 3670015))) as usize] };
			let mut fTemp891: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp889 as usize] };
			let mut fTemp892: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp889, 1), 3670015))) as usize] } - fTemp891;
			let mut iTemp893: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp891 + fTemp769 * fTemp892 + (fTemp887 - (iTemp888) as F64) * (fTemp890 - (fTemp891 + fTemp769 * (fTemp892 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp889, 8), 3670015))) as usize] } - fTemp890))))} else {1.0 - (fTemp885 + fTemp769 * fTemp886 + (fTemp881 - (iTemp882) as F64) * (fTemp884 - (fTemp885 + fTemp769 * (fTemp886 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp883, 8)) as usize] } - fTemp884)))))} - fTemp879) / (1.0 - fTemp879))) as i32;
			...
			let mut iTemp900: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp899, 524287)))), 3670015));
			let mut fTemp901: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp900, 7)) as usize] };
			...
			let mut iTemp906: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp905, 524287)))), 3670015));
			let mut fTemp907: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp906, 7)) as usize] };
			...
			let mut iTemp920: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp919, 524287)))), 3670015));
			let mut fTemp921: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp920, 7), 3670015))) as usize] };
			let mut fTemp922: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp920 as usize] };
			let mut fTemp923: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp920, 1), 3670015))) as usize] } - fTemp922;
			let mut iTemp924: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp922 + fTemp769 * fTemp923 + (fTemp918 - (iTemp919) as F64) * (fTemp921 - (fTemp922 + fTemp769 * (fTemp923 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp920, 8), 3670015))) as usize] } - fTemp921))))} else {1.0 - (fTemp916 + fTemp769 * fTemp917 + (fTemp912 - (iTemp913) as F64) * (fTemp915 - (fTemp916 + fTemp769 * (fTemp917 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp914, 8)) as usize] } - fTemp915)))))} - fTemp910) / (1.0 - fTemp910))) as i32;
			...
			let mut iTemp931: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp930, 524287)))), 3670015));
			let mut fTemp932: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp931, 7)) as usize] };
			...
			let mut iTemp937: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp936, 524287)))), 3670015));
			let mut fTemp938: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp937, 7)) as usize] };
			...
			let mut iTemp951: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp950, 524287)))), 3670015));
			let mut fTemp952: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp951, 7), 3670015))) as usize] };
			let mut fTemp953: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp951 as usize] };
			let mut fTemp954: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp951, 1), 3670015))) as usize] } - fTemp953;
			let mut iTemp955: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp953 + fTemp769 * fTemp954 + (fTemp949 - (iTemp950) as F64) * (fTemp952 - (fTemp953 + fTemp769 * (fTemp954 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp951, 8), 3670015))) as usize] } - fTemp952))))} else {1.0 - (fTemp947 + fTemp769 * fTemp948 + (fTemp943 - (iTemp944) as F64) * (fTemp946 - (fTemp947 + fTemp769 * (fTemp948 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp945, 8)) as usize] } - fTemp946)))))} - fTemp941) / (1.0 - fTemp941))) as i32;
			...
			let mut iTemp962: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp961, 524287)))), 3670015));
			let mut fTemp963: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp962, 7)) as usize] };
			...
			let mut iTemp968: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp967, 524287)))), 3670015));
			let mut fTemp969: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp968, 7)) as usize] };
			...
			let mut fTemp972: F64 = if iTemp760 != 0 {fTemp970 + fTemp769 * fTemp971 + (fTemp966 - (iTemp967) as F64) * (fTemp969 - (fTemp970 + fTemp769 * (fTemp971 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp968, 8)) as usize] } - fTemp969))))} else {1.0 - (fTemp964 + fTemp769 * fTemp965 + (fTemp960 - (iTemp961) as F64) * (fTemp963 - (fTemp964 + fTemp769 * (fTemp965 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp962, 8)) as usize] } - fTemp963)))))};
			let mut fTemp973: F64 = fTemp774 + fTemp959;
			let mut fTemp974: F64 = 524287.0 * (1.0 - fTemp973);
			let mut iTemp975: i32 = (fTemp974) as i32;
			let mut iTemp976: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp975, 524287)))), 3670015));
			let mut fTemp977: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp976, 7)) as usize] };
			...
			let mut iTemp982: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp981, 524287)))), 3670015));
			let mut fTemp983: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp982, 7), 3670015))) as usize] };
			let mut fTemp984: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp982 as usize] };
			let mut fTemp985: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp982, 1), 3670015))) as usize] } - fTemp984;
			let mut iTemp986: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp984 + fTemp769 * fTemp985 + (fTemp980 - (iTemp981) as F64) * (fTemp983 - (fTemp984 + fTemp769 * (fTemp985 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp982, 8), 3670015))) as usize] } - fTemp983))))} else {1.0 - (fTemp978 + fTemp769 * fTemp979 + (fTemp974 - (iTemp975) as F64) * (fTemp977 - (fTemp978 + fTemp769 * (fTemp979 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp976, 8)) as usize] } - fTemp977)))))} - fTemp972) / (1.0 - fTemp972))) as i32;
			...
			let mut iTemp993: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp992, 524287)))), 3670015));
			let mut fTemp994: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp993, 7)) as usize] };
			...
			let mut iTemp999: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp998, 524287)))), 3670015));
			let mut fTemp1000: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp999, 7)) as usize] };
			...
			let mut fTemp1003: F64 = if iTemp760 != 0 {fTemp1001 + fTemp769 * fTemp1002 + (fTemp997 - (iTemp998) as F64) * (fTemp1000 - (fTemp1001 + fTemp769 * (fTemp1002 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp999, 8)) as usize] } - fTemp1000))))} else {1.0 - (fTemp995 + fTemp769 * fTemp996 + (fTemp991 - (iTemp992) as F64) * (fTemp994 - (fTemp995 + fTemp769 * (fTemp996 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp993, 8)) as usize] } - fTemp994)))))};
			...
			let mut iTemp1007: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1006, 524287)))), 3670015));
			let mut fTemp1008: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1007, 7)) as usize] };
			...
			let mut iTemp1013: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1012, 524287)))), 3670015));
			let mut fTemp1014: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1013, 7), 3670015))) as usize] };
			let mut fTemp1015: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1013 as usize] };
			let mut fTemp1016: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1013, 1), 3670015))) as usize] } - fTemp1015;
			let mut iTemp1017: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp1015 + fTemp769 * fTemp1016 + (fTemp1011 - (iTemp1012) as F64) * (fTemp1014 - (fTemp1015 + fTemp769 * (fTemp1016 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1013, 8), 3670015))) as usize] } - fTemp1014))))} else {1.0 - (fTemp1009 + fTemp769 * fTemp1010 + (fTemp1005 - (iTemp1006) as F64) * (fTemp1008 - (fTemp1009 + fTemp769 * (fTemp1010 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1007, 8)) as usize] } - fTemp1008)))))} - fTemp1003) / (1.0 - fTemp1003))) as i32;
			...
			let mut iTemp1024: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1023, 524287)))), 3670015));
			let mut fTemp1025: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1024, 7)) as usize] };
			...
			let mut iTemp1030: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1029, 524287)))), 3670015));
			let mut fTemp1031: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1030, 7)) as usize] };
			...
			let mut iTemp1038: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1037, 524287)))), 3670015));
			let mut fTemp1039: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1038, 7)) as usize] };
			...
			let mut iTemp1044: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1043, 524287)))), 3670015));
			let mut fTemp1045: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1044, 7), 3670015))) as usize] };
			let mut fTemp1046: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1044 as usize] };
			let mut fTemp1047: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1044, 1), 3670015))) as usize] } - fTemp1046;
			let mut iTemp1048: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp1046 + fTemp769 * fTemp1047 + (fTemp1042 - (iTemp1043) as F64) * (fTemp1045 - (fTemp1046 + fTemp769 * (fTemp1047 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1044, 8), 3670015))) as usize] } - fTemp1045))))} else {1.0 - (fTemp1040 + fTemp769 * fTemp1041 + (fTemp1036 - (iTemp1037) as F64) * (fTemp1039 - (fTemp1040 + fTemp769 * (fTemp1041 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1038, 8)) as usize] } - fTemp1039)))))} - fTemp1034) / (1.0 - fTemp1034))) as i32;
			...
			let mut iTemp1055: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1054, 524287)))), 3670015));
			let mut fTemp1056: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1055, 7)) as usize] };
			...
			let mut iTemp1061: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1060, 524287)))), 3670015));
			let mut fTemp1062: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1061, 7)) as usize] };
			...
			let mut iTemp1069: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1068, 524287)))), 3670015));
			let mut fTemp1070: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1069, 7)) as usize] };
			...
			let mut iTemp1075: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1074, 524287)))), 3670015));
			let mut fTemp1076: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1075, 7), 3670015))) as usize] };
			let mut fTemp1077: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1075 as usize] };
			let mut fTemp1078: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1075, 1), 3670015))) as usize] } - fTemp1077;
			let mut iTemp1079: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp1077 + fTemp769 * fTemp1078 + (fTemp1073 - (iTemp1074) as F64) * (fTemp1076 - (fTemp1077 + fTemp769 * (fTemp1078 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1075, 8), 3670015))) as usize] } - fTemp1076))))} else {1.0 - (fTemp1071 + fTemp769 * fTemp1072 + (fTemp1067 - (iTemp1068) as F64) * (fTemp1070 - (fTemp1071 + fTemp769 * (fTemp1072 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1069, 8)) as usize] } - fTemp1070)))))} - fTemp1065) / (1.0 - fTemp1065))) as i32;
			...
			let mut iTemp1086: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1085, 524287)))), 3670015));
			let mut fTemp1087: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1086, 7)) as usize] };
			...
			let mut iTemp1092: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1091, 524287)))), 3670015));
			let mut fTemp1093: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1092, 7)) as usize] };
			...
			let mut fTemp1096: F64 = if iTemp760 != 0 {fTemp1094 + fTemp769 * fTemp1095 + (fTemp1090 - (iTemp1091) as F64) * (fTemp1093 - (fTemp1094 + fTemp769 * (fTemp1095 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1092, 8)) as usize] } - fTemp1093))))} else {1.0 - (fTemp1088 + fTemp769 * fTemp1089 + (fTemp1084 - (iTemp1085) as F64) * (fTemp1087 - (fTemp1088 + fTemp769 * (fTemp1089 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1086, 8)) as usize] } - fTemp1087)))))};
			...
			let mut iTemp1100: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1099, 524287)))), 3670015));
			let mut fTemp1101: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1100, 7)) as usize] };
			...
			let mut iTemp1106: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1105, 524287)))), 3670015));
			let mut fTemp1107: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1106, 7), 3670015))) as usize] };
			let mut fTemp1108: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1106 as usize] };
			let mut fTemp1109: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1106, 1), 3670015))) as usize] } - fTemp1108;
			let mut iTemp1110: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp1108 + fTemp769 * fTemp1109 + (fTemp1104 - (iTemp1105) as F64) * (fTemp1107 - (fTemp1108 + fTemp769 * (fTemp1109 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1106, 8), 3670015))) as usize] } - fTemp1107))))} else {1.0 - (fTemp1102 + fTemp769 * fTemp1103 + (fTemp1098 - (iTemp1099) as F64) * (fTemp1101 - (fTemp1102 + fTemp769 * (fTemp1103 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1100, 8)) as usize] } - fTemp1101)))))} - fTemp1096) / (1.0 - fTemp1096))) as i32;
			...
			let mut iTemp1117: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1116, 524287)))), 3670015));
			let mut fTemp1118: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1117, 7)) as usize] };
			...
			let mut iTemp1123: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1122, 524287)))), 3670015));
			let mut fTemp1124: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1123, 7)) as usize] };
			...
			let mut fTemp1127: F64 = if iTemp760 != 0 {fTemp1125 + fTemp769 * fTemp1126 + (fTemp1121 - (iTemp1122) as F64) * (fTemp1124 - (fTemp1125 + fTemp769 * (fTemp1126 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1123, 8)) as usize] } - fTemp1124))))} else {1.0 - (fTemp1119 + fTemp769 * fTemp1120 + (fTemp1115 - (iTemp1116) as F64) * (fTemp1118 - (fTemp1119 + fTemp769 * (fTemp1120 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1117, 8)) as usize] } - fTemp1118)))))};
			...
			let mut iTemp1131: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1130, 524287)))), 3670015));
			let mut fTemp1132: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1131, 7)) as usize] };
			...
			let mut iTemp1137: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1136, 524287)))), 3670015));
			let mut fTemp1138: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1137, 7), 3670015))) as usize] };
			let mut fTemp1139: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1137 as usize] };
			let mut fTemp1140: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1137, 1), 3670015))) as usize] } - fTemp1139;
			...
			let mut iTemp1148: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1147, 524287)))), 3670015));
			let mut fTemp1149: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1148, 7)) as usize] };
			...
			let mut iTemp1154: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1153, 524287)))), 3670015));
			let mut fTemp1155: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1154, 7)) as usize] };
			...
			let mut iTemp1162: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1161, 524287)))), 3670015));
			let mut fTemp1163: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1162, 7)) as usize] };
			...
			let mut iTemp1168: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1167, 524287)))), 3670015));
			let mut fTemp1169: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1168, 7), 3670015))) as usize] };
			let mut fTemp1170: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1168 as usize] };
			let mut fTemp1171: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1168, 1), 3670015))) as usize] } - fTemp1170;
			let mut iTemp1172: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp1170 + fTemp769 * fTemp1171 + (fTemp1166 - (iTemp1167) as F64) * (fTemp1169 - (fTemp1170 + fTemp769 * (fTemp1171 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1168, 8), 3670015))) as usize] } - fTemp1169))))} else {1.0 - (fTemp1164 + fTemp769 * fTemp1165 + (fTemp1160 - (iTemp1161) as F64) * (fTemp1163 - (fTemp1164 + fTemp769 * (fTemp1165 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1162, 8)) as usize] } - fTemp1163)))))} - fTemp1158) / (1.0 - fTemp1158))) as i32;
			...
			let mut iTemp1179: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1178, 524287)))), 3670015));
			let mut fTemp1180: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1179, 7)) as usize] };
			...
			let mut iTemp1185: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1184, 524287)))), 3670015));
			let mut fTemp1186: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1185, 7)) as usize] };
			...
			let mut iTemp1193: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1192, 524287)))), 3670015));
			let mut fTemp1194: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1193, 7)) as usize] };
			...
			let mut iTemp1199: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1198, 524287)))), 3670015));
			let mut fTemp1200: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1199, 7), 3670015))) as usize] };
			let mut fTemp1201: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1199 as usize] };
			let mut fTemp1202: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1199, 1), 3670015))) as usize] } - fTemp1201;
			let mut iTemp1203: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp1201 + fTemp769 * fTemp1202 + (fTemp1197 - (iTemp1198) as F64) * (fTemp1200 - (fTemp1201 + fTemp769 * (fTemp1202 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1199, 8), 3670015))) as usize] } - fTemp1200))))} else {1.0 - (fTemp1195 + fTemp769 * fTemp1196 + (fTemp1191 - (iTemp1192) as F64) * (fTemp1194 - (fTemp1195 + fTemp769 * (fTemp1196 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1193, 8)) as usize] } - fTemp1194)))))} - fTemp1189) / (1.0 - fTemp1189))) as i32;
			...
			let mut iTemp1210: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1209, 524287)))), 3670015));
			let mut fTemp1211: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1210, 7)) as usize] };
			let mut fTemp1212: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1210 as usize] };
			let mut fTemp1213: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1210, 1)) as usize] } - fTemp1212;
			let mut fTemp1214: F64 = 262143.5 * fTemp1206;
			let mut iTemp1215: i32 = (fTemp1214) as i32;
			let mut iTemp1216: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1215, 524287)))), 3670015));
			let mut fTemp1217: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1216, 7)) as usize] };
			let mut fTemp1218: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1216 as usize] };
			let mut fTemp1219: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1216, 1)) as usize] } - fTemp1218;
			let mut fTemp1220: F64 = if iTemp760 != 0 {fTemp1218 + fTemp769 * fTemp1219 + (fTemp1214 - (iTemp1215) as F64) * (fTemp1217 - (fTemp1218 + fTemp769 * (fTemp1219 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1216, 8)) as usize] } - fTemp1217))))} else {1.0 - (fTemp1212 + fTemp769 * fTemp1213 + (fTemp1208 - (iTemp1209) as F64) * (fTemp1211 - (fTemp1212 + fTemp769 * (fTemp1213 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1210, 8)) as usize] } - fTemp1211)))))};
			...
			let mut iTemp1224: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1223, 524287)))), 3670015));
			let mut fTemp1225: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1224, 7)) as usize] };
			let mut fTemp1226: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1224 as usize] };
			let mut fTemp1227: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1224, 1)) as usize] } - fTemp1226;
			let mut fTemp1228: F64 = 524287.0 * fTemp1221;
			let mut iTemp1229: i32 = (fTemp1228) as i32;
			let mut iTemp1230: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1229, 524287)))), 3670015));
			let mut fTemp1231: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1230, 7), 3670015))) as usize] };
			let mut fTemp1232: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1230 as usize] };
			let mut fTemp1233: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1230, 1), 3670015))) as usize] } - fTemp1232;
			let mut iTemp1234: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp1232 + fTemp769 * fTemp1233 + (fTemp1228 - (iTemp1229) as F64) * (fTemp1231 - (fTemp1232 + fTemp769 * (fTemp1233 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1230, 8), 3670015))) as usize] } - fTemp1231))))} else {1.0 - (fTemp1226 + fTemp769 * fTemp1227 + (fTemp1222 - (iTemp1223) as F64) * (fTemp1225 - (fTemp1226 + fTemp769 * (fTemp1227 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1224, 8)) as usize] } - fTemp1225)))))} - fTemp1220) / (1.0 - fTemp1220))) as i32;
			...
			let mut iTemp1241: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1240, 524287)))), 3670015));
			let mut fTemp1242: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1241, 7)) as usize] };
			let mut fTemp1243: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1241 as usize] };
			let mut fTemp1244: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1241, 1)) as usize] } - fTemp1243;
			let mut fTemp1245: F64 = 262143.5 * fTemp1237;
			let mut iTemp1246: i32 = (fTemp1245) as i32;
			let mut iTemp1247: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1246, 524287)))), 3670015));
			let mut fTemp1248: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1247, 7)) as usize] };
			let mut fTemp1249: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1247 as usize] };
			let mut fTemp1250: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1247, 1)) as usize] } - fTemp1249;
			let mut fTemp1251: F64 = if iTemp760 != 0 {fTemp1249 + fTemp769 * fTemp1250 + (fTemp1245 - (iTemp1246) as F64) * (fTemp1248 - (fTemp1249 + fTemp769 * (fTemp1250 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1247, 8)) as usize] } - fTemp1248))))} else {1.0 - (fTemp1243 + fTemp769 * fTemp1244 + (fTemp1239 - (iTemp1240) as F64) * (fTemp1242 - (fTemp1243 + fTemp769 * (fTemp1244 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1241, 8)) as usize] } - fTemp1242)))))};
			...
			let mut iTemp1255: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1254, 524287)))), 3670015));
			let mut fTemp1256: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1255, 7)) as usize] };
			let mut fTemp1257: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1255 as usize] };
			let mut fTemp1258: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1255, 1)) as usize] } - fTemp1257;
			let mut fTemp1259: F64 = 524287.0 * fTemp1252;
			let mut iTemp1260: i32 = (fTemp1259) as i32;
			let mut iTemp1261: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1260, 524287)))), 3670015));
			let mut fTemp1262: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1261, 7), 3670015))) as usize] };
			let mut fTemp1263: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1261 as usize] };
			let mut fTemp1264: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1261, 1), 3670015))) as usize] } - fTemp1263;
			let mut iTemp1265: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp1263 + fTemp769 * fTemp1264 + (fTemp1259 - (iTemp1260) as F64) * (fTemp1262 - (fTemp1263 + fTemp769 * (fTemp1264 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1261, 8), 3670015))) as usize] } - fTemp1262))))} else {1.0 - (fTemp1257 + fTemp769 * fTemp1258 + (fTemp1253 - (iTemp1254) as F64) * (fTemp1256 - (fTemp1257 + fTemp769 * (fTemp1258 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1255, 8)) as usize] } - fTemp1256)))))} - fTemp1251) / (1.0 - fTemp1251))) as i32;
			...
			let mut iTemp1272: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1271, 524287)))), 3670015));
			let mut fTemp1273: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1272, 7)) as usize] };
			let mut fTemp1274: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1272 as usize] };
			let mut fTemp1275: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1272, 1)) as usize] } - fTemp1274;
			let mut fTemp1276: F64 = 262143.5 * fTemp1268;
			let mut iTemp1277: i32 = (fTemp1276) as i32;
			let mut iTemp1278: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1277, 524287)))), 3670015));
			let mut fTemp1279: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1278, 7)) as usize] };
			let mut fTemp1280: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1278 as usize] };
			let mut fTemp1281: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1278, 1)) as usize] } - fTemp1280;
			let mut fTemp1282: F64 = if iTemp760 != 0 {fTemp1280 + fTemp769 * fTemp1281 + (fTemp1276 - (iTemp1277) as F64) * (fTemp1279 - (fTemp1280 + fTemp769 * (fTemp1281 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1278, 8)) as usize] } - fTemp1279))))} else {1.0 - (fTemp1274 + fTemp769 * fTemp1275 + (fTemp1270 - (iTemp1271) as F64) * (fTemp1273 - (fTemp1274 + fTemp769 * (fTemp1275 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1272, 8)) as usize] } - fTemp1273)))))};
			...
			let mut iTemp1286: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1285, 524287)))), 3670015));
			let mut fTemp1287: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1286, 7)) as usize] };
			let mut fTemp1288: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1286 as usize] };
			let mut fTemp1289: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1286, 1)) as usize] } - fTemp1288;
			let mut fTemp1290: F64 = 524287.0 * fTemp1283;
			let mut iTemp1291: i32 = (fTemp1290) as i32;
			let mut iTemp1292: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1291, 524287)))), 3670015));
			let mut fTemp1293: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1292, 7), 3670015))) as usize] };
			let mut fTemp1294: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1292 as usize] };
			let mut fTemp1295: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1292, 1), 3670015))) as usize] } - fTemp1294;
			let mut iTemp1296: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp1294 + fTemp769 * fTemp1295 + (fTemp1290 - (iTemp1291) as F64) * (fTemp1293 - (fTemp1294 + fTemp769 * (fTemp1295 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1292, 8), 3670015))) as usize] } - fTemp1293))))} else {1.0 - (fTemp1288 + fTemp769 * fTemp1289 + (fTemp1284 - (iTemp1285) as F64) * (fTemp1287 - (fTemp1288 + fTemp769 * (fTemp1289 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1286, 8)) as usize] } - fTemp1287)))))} - fTemp1282) / (1.0 - fTemp1282))) as i32;
			...
			let mut iTemp1303: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1302, 524287)))), 3670015));
			let mut fTemp1304: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1303, 7)) as usize] };
			let mut fTemp1305: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1303 as usize] };
			let mut fTemp1306: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1303, 1)) as usize] } - fTemp1305;
			let mut fTemp1307: F64 = 262143.5 * fTemp1299;
			let mut iTemp1308: i32 = (fTemp1307) as i32;
			let mut iTemp1309: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1308, 524287)))), 3670015));
			let mut fTemp1310: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1309, 7)) as usize] };
			let mut fTemp1311: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1309 as usize] };
			let mut fTemp1312: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1309, 1)) as usize] } - fTemp1311;
			let mut fTemp1313: F64 = if iTemp760 != 0 {fTemp1311 + fTemp769 * fTemp1312 + (fTemp1307 - (iTemp1308) as F64) * (fTemp1310 - (fTemp1311 + fTemp769 * (fTemp1312 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1309, 8)) as usize] } - fTemp1310))))} else {1.0 - (fTemp1305 + fTemp769 * fTemp1306 + (fTemp1301 - (iTemp1302) as F64) * (fTemp1304 - (fTemp1305 + fTemp769 * (fTemp1306 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1303, 8)) as usize] } - fTemp1304)))))};
			...
			let mut iTemp1317: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1316, 524287)))), 3670015));
			let mut fTemp1318: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1317, 7)) as usize] };
			let mut fTemp1319: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1317 as usize] };
			let mut fTemp1320: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1317, 1)) as usize] } - fTemp1319;
			let mut fTemp1321: F64 = 524287.0 * fTemp1314;
			let mut iTemp1322: i32 = (fTemp1321) as i32;
			let mut iTemp1323: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1322, 524287)))), 3670015));
			let mut fTemp1324: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1323, 7), 3670015))) as usize] };
			let mut fTemp1325: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1323 as usize] };
			let mut fTemp1326: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1323, 1), 3670015))) as usize] } - fTemp1325;
			let mut iTemp1327: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp1325 + fTemp769 * fTemp1326 + (fTemp1321 - (iTemp1322) as F64) * (fTemp1324 - (fTemp1325 + fTemp769 * (fTemp1326 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1323, 8), 3670015))) as usize] } - fTemp1324))))} else {1.0 - (fTemp1319 + fTemp769 * fTemp1320 + (fTemp1315 - (iTemp1316) as F64) * (fTemp1318 - (fTemp1319 + fTemp769 * (fTemp1320 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1317, 8)) as usize] } - fTemp1318)))))} - fTemp1313) / (1.0 - fTemp1313))) as i32;
			...
			let mut iTemp1334: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1333, 524287)))), 3670015));
			let mut fTemp1335: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1334, 7)) as usize] };
			let mut fTemp1336: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1334 as usize] };
			let mut fTemp1337: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1334, 1)) as usize] } - fTemp1336;
			let mut fTemp1338: F64 = 262143.5 * fTemp1330;
			let mut iTemp1339: i32 = (fTemp1338) as i32;
			let mut iTemp1340: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1339, 524287)))), 3670015));
			let mut fTemp1341: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1340, 7)) as usize] };
			let mut fTemp1342: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1340 as usize] };
			let mut fTemp1343: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1340, 1)) as usize] } - fTemp1342;
			let mut fTemp1344: F64 = if iTemp760 != 0 {fTemp1342 + fTemp769 * fTemp1343 + (fTemp1338 - (iTemp1339) as F64) * (fTemp1341 - (fTemp1342 + fTemp769 * (fTemp1343 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1340, 8)) as usize] } - fTemp1341))))} else {1.0 - (fTemp1336 + fTemp769 * fTemp1337 + (fTemp1332 - (iTemp1333) as F64) * (fTemp1335 - (fTemp1336 + fTemp769 * (fTemp1337 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1334, 8)) as usize] } - fTemp1335)))))};
			...
			let mut iTemp1348: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1347, 524287)))), 3670015));
			let mut fTemp1349: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1348, 7)) as usize] };
			let mut fTemp1350: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1348 as usize] };
			let mut fTemp1351: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1348, 1)) as usize] } - fTemp1350;
			let mut fTemp1352: F64 = 524287.0 * fTemp1345;
			let mut iTemp1353: i32 = (fTemp1352) as i32;
			let mut iTemp1354: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1353, 524287)))), 3670015));
			let mut fTemp1355: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1354, 7), 3670015))) as usize] };
			let mut fTemp1356: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1354 as usize] };
			let mut fTemp1357: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1354, 1), 3670015))) as usize] } - fTemp1356;
			let mut iTemp1358: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp1356 + fTemp769 * fTemp1357 + (fTemp1352 - (iTemp1353) as F64) * (fTemp1355 - (fTemp1356 + fTemp769 * (fTemp1357 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1354, 8), 3670015))) as usize] } - fTemp1355))))} else {1.0 - (fTemp1350 + fTemp769 * fTemp1351 + (fTemp1346 - (iTemp1347) as F64) * (fTemp1349 - (fTemp1350 + fTemp769 * (fTemp1351 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1348, 8)) as usize] } - fTemp1349)))))} - fTemp1344) / (1.0 - fTemp1344))) as i32;
			...
			let mut iTemp1365: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1364, 524287)))), 3670015));
			let mut fTemp1366: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1365, 7)) as usize] };
			let mut fTemp1367: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1365 as usize] };
			let mut fTemp1368: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1365, 1)) as usize] } - fTemp1367;
			let mut fTemp1369: F64 = 262143.5 * fTemp1361;
			let mut iTemp1370: i32 = (fTemp1369) as i32;
			let mut iTemp1371: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1370, 524287)))), 3670015));
			let mut fTemp1372: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1371, 7)) as usize] };
			let mut fTemp1373: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1371 as usize] };
			let mut fTemp1374: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1371, 1)) as usize] } - fTemp1373;
			let mut fTemp1375: F64 = if iTemp760 != 0 {fTemp1373 + fTemp769 * fTemp1374 + (fTemp1369 - (iTemp1370) as F64) * (fTemp1372 - (fTemp1373 + fTemp769 * (fTemp1374 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1371, 8), 3670015))) as usize] } - fTemp1372))))} else {1.0 - (fTemp1367 + fTemp769 * fTemp1368 + (fTemp1363 - (iTemp1364) as F64) * (fTemp1366 - (fTemp1367 + fTemp769 * (fTemp1368 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1365, 8), 3670015))) as usize] } - fTemp1366)))))};
			...
			let mut iTemp1379: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1378, 524287)))), 3670015));
			let mut fTemp1380: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1379, 7)) as usize] };
			let mut fTemp1381: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1379 as usize] };
			let mut fTemp1382: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1379, 1)) as usize] } - fTemp1381;
			let mut fTemp1383: F64 = 524287.0 * fTemp1376;
			let mut iTemp1384: i32 = (fTemp1383) as i32;
			let mut iTemp1385: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1384, 524287)))), 3670015));
			let mut fTemp1386: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1385, 7), 3670015))) as usize] };
			let mut fTemp1387: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1385 as usize] };
			let mut fTemp1388: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1385, 1), 3670015))) as usize] } - fTemp1387;
			let mut iTemp1389: i32 = (fTemp830 > ((if iTemp760 != 0 {fTemp1387 + fTemp769 * fTemp1388 + (fTemp1383 - (iTemp1384) as F64) * (fTemp1386 - (fTemp1387 + fTemp769 * (fTemp1388 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1385, 8), 3670015))) as usize] } - fTemp1386))))} else {1.0 - (fTemp1381 + fTemp769 * fTemp1382 + (fTemp1377 - (iTemp1378) as F64) * (fTemp1380 - (fTemp1381 + fTemp769 * (fTemp1382 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1379, 8)) as usize] } - fTemp1380)))))} - fTemp1375) / (1.0 - fTemp1375))) as i32;
			let mut fTemp1390: F64 = F64::min(1.0, F64::max(0.0, 0.5 * (if iTemp1389 != 0 {fTemp1362} else {fTemp1360} + if iTemp1389 != 0 {fTemp1359} else {fTemp1362})));
			self.fRec15[0] = fTemp1390;
			let mut fTemp1391: F64 = 524287.0 * (1.0 - fTemp1390);
			let mut iTemp1392: i32 = (fTemp1391) as i32;
			let mut iTemp1393: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1392, 524287)))), 3670015));
			let mut fTemp1394: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1393, 7)) as usize] };
			let mut fTemp1395: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1393 as usize] };
			let mut fTemp1396: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1393, 1)) as usize] } - fTemp1395;
			let mut fTemp1397: F64 = 524287.0 * fTemp1390;
			let mut iTemp1398: i32 = (fTemp1397) as i32;
			let mut iTemp1399: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1398, 524287)))), 3670015));
			let mut fTemp1400: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1399, 7)) as usize] };
			let mut fTemp1401: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1399 as usize] };
			let mut fTemp1402: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1399, 1)) as usize] } - fTemp1401;
			let mut fTemp1403: F64 = if iTemp760 != 0 {fTemp1401 + fTemp769 * fTemp1402 + (fTemp1397 - (iTemp1398) as F64) * (fTemp1400 - (fTemp1401 + fTemp769 * (fTemp1402 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1399, 8), 3670015))) as usize] } - fTemp1400))))} else {1.0 - (fTemp1395 + fTemp769 * fTemp1396 + (fTemp1391 - (iTemp1392) as F64) * (fTemp1394 - (fTemp1395 + fTemp769 * (fTemp1396 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1393, 8), 3670015))) as usize] } - fTemp1394)))))};
			...
			let mut iTemp1407: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1406, 524287)))), 3670015));
			let mut fTemp1408: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1407, 7)) as usize] };
			let mut fTemp1409: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1407 as usize] };
			let mut fTemp1410: F64 = unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1407, 1)) as usize] } - fTemp1409;
			let mut fTemp1411: F64 = 524287.0 * fTemp1404;
			let mut iTemp1412: i32 = (fTemp1411) as i32;
			let mut iTemp1413: i32 = std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp764, i32::wrapping_mul(7, std::cmp::max(0, std::cmp::min(iTemp1412, 524287)))), 3670015));
			let mut fTemp1414: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1413, 7), 3670015))) as usize] };
			let mut fTemp1415: F64 = unsafe { ftbl0LambRs192kSIG0[iTemp1413 as usize] };
			let mut fTemp1416: F64 = unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1413, 1), 3670015))) as usize] } - fTemp1415;
			let mut fTemp1417: F64 = self.fRec16[1] + if ((0.001 * fTemp773) == 0.0) as i32 != 0 {fTemp759} else {fTemp759 * (if iTemp760 != 0 {fTemp1415 + fTemp769 * fTemp1416 + (fTemp1411 - (iTemp1412) as F64) * (fTemp1414 - (fTemp1415 + fTemp769 * (fTemp1416 - (unsafe { ftbl0LambRs192kSIG0[(std::cmp::max(0, std::cmp::min(i32::wrapping_add(iTemp1413, 8), 3670015))) as usize] } - fTemp1414))))} else {1.0 - (fTemp1409 + fTemp769 * fTemp1410 + (fTemp1405 - (iTemp1406) as F64) * (fTemp1408 - (fTemp1409 + fTemp769 * (fTemp1410 - (unsafe { ftbl0LambRs192kSIG0[(i32::wrapping_add(iTemp1407, 8)) as usize] } - fTemp1408)))))} - fTemp1403) / (1.0 - fTemp1403)};
			self.fRec16[0] = if iTemp772 != 0 {F64::min(fTemp1417, self.fRec16[1])} else {F64::max(fTemp1417, self.fRec16[1])};
			self.fVec66[(self.IOTA0 & 32767) as usize] = F64::powf(1e+01, 0.05 * self.fRec16[0]);
			let mut fTemp1418: F64 = self.fVec66[((i32::wrapping_sub(self.IOTA0, iSlow78)) & 32767) as usize];
			*output1 = 0.5 * fTemp2 * self.fVec3[((i32::wrapping_sub(self.IOTA0, iSlow79)) & 32767) as usize] + self.fRec14[0] * fTemp4 * self.fVec4[((i32::wrapping_sub(self.IOTA0, iSlow79)) & 32767) as usize] * fTemp1418;
