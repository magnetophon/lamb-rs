...
Compilation options: -a /tmp/.tmpNuW8ar -lang rust -ct 1 -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
#![allow(clippy::all)]
#![allow(unused_parens)]
...
impl FaustDsp for mydsp {
	...
	fn metadata(&self, m: &mut dyn Meta) { 
		m.declare("compile_options", "-a /tmp/.tmpNuW8ar -lang rust -ct 1 -es 1 -mcd 16 -single -ftz 0");
