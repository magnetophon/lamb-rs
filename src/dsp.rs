...
Compilation options: -a /run/user/1001/.tmptq15v8 -lang rust -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
#![allow(clippy::all)]
#![allow(unused_parens)]
...
impl FaustDsp for mydsp {
	...
	fn metadata(&self, m: &mut dyn Meta) { 
		...
		m.declare("compile_options", r"-a /run/user/1001/.tmptq15v8 -lang rust -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
